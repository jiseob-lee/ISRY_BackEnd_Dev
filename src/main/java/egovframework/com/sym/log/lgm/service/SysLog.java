...
public class SysLog implements Serializable{
	...
	/**
	 * @return the srchFactrCn
	 */
	public String getSrchFactrCn() {
		return srchFactrCn;
	}
	/**
	 * @param srchFactrCn the srchFactrCn to set
	 */
	public void setSrchFactrCn(String srchFactrCn) {
		this.srchFactrCn = srchFactrCn;
	}
