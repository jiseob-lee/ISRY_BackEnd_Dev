 ...
 ******************************************************************************************/
package isry.couns.constt.bbscrs.service;
 ...
 * -                
 */
public interface BbscrsListService {
	...
	Map<String, Object> saveBbscrsIndv(HttpServletRequest request, DataRequest dataRequest);
