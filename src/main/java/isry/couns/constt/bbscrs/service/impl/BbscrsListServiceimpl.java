 ...
 ******************************************************************************************/
package isry.couns.constt.bbscrs.service.impl;
...
import isry.couns.constt.bbscrs.mapper.BbscrsListMapper;
...
@Service("BbscrsListService")
public class BbscrsListServiceimpl implements BbscrsListService{
	
	@Resource(name = "BbscrsListMapper")
	private BbscrsListMapper bbscrsListMapper;

	@Resource(name="userLoginService")
	private UserLoginService userLoginService;
	
	@Override
	public List<Map<String, Object>> selectBbscrsList1(Map<String, Object> mapParam) {
        List<Map<String, Object>> list = bbscrsListMapper.selectBbscrsList1(mapParam);
		return list;
	}
	
	@Override
	public List<Map<String, Object>> selectBbscrsList2(Map<String, Object> mapParam) {
        List<Map<String, Object>> list = bbscrsListMapper.selectBbscrsList2(mapParam);
		return list;
	}
	
	@Override
	public List<Map<String, Object>> selectBbscrsList3(Map<String, Object> mapParam) {
        List<Map<String, Object>> list = bbscrsListMapper.selectBbscrsList3(mapParam);
		return list;
	}
	
	@Override
	public List<Map<String, Object>> selectBbscrsList4(Map<String, Object> mapParam) {
        List<Map<String, Object>> list = bbscrsListMapper.selectBbscrsList4(mapParam);
		return list;
	}
	
	@Override
	public List<Map<String, Object>> selectBbscrsList5(Map<String, Object> mapParam) {
        List<Map<String, Object>> list = bbscrsListMapper.selectBbscrsList5(mapParam);
		return list;
	}
	
	@Override
	public List<Map<String, Object>> selectBbscrsList6(Map<String, Object> mapParam) {
        List<Map<String, Object>> list = bbscrsListMapper.selectBbscrsList6(mapParam);
		return list;
	}
	...
	public int getTotalCount(Map<String, Object> mapParam) {
		...
		return bbscrsListMapper.getTotalCount(mapParam);
	}

	@Override
	public List<Map<String, Object>> selecBbscrsIndvList(Map<String, Object> mapParam) {
		// TODO Auto-generated method stub
		return bbscrsListMapper.selecBbscrsIndvList(mapParam);
	}

	@Override
	public List<Map<String, Object>> selecBbscrsIndvDetail(Map<String, Object> mapParam) {
		// TODO Auto-generated method stub
		return bbscrsListMapper.selecBbscrsIndvDetail(mapParam);
	}
...
//
	@Override
	public Map<String, Object> saveBbscrsIndv(HttpServletRequest request, DataRequest dataRequest) {
		Map<String, Object> mapReturn = new HashMap<String, Object>();
		ParameterGroup dsList = dataRequest.getParameterGroup("dsList");
//		System.out.println("?????????????? 111: " + dsList.toString());
//		System.out.println("?????????????? 222: " + dsList.rowSize());
		
		// 2022.11.11 이태호_주석으로 막음
//		if(dsList.getValue("PVSN_SHAPE_EML_YN") == null || dsList.getValue("PVSN_SHAPE_EML_YN").equals("")) {
//			System.out.println("?????????????? 333: " + dsList.getValue("PVSN_SHAPE_EML_YN"));
...
//		}
//		
//		// System.out.println("TTTTTTT1 : "+dsList.getValue("MHW129_YN"));
//		
...
//		System.out.println("dsList = "+dsList);
		...
		while (insertedRows.hasNext()) {
			...
			// data 암호화
			mapIns.put("CLIENA_NM_ENCPT", mapIns.get("CLIENA_NM_ENCPT"));			// 내담자명암호화
			mapIns.put("MBL_TELNO_ENCPT", mapIns.get("MBL_TELNO_ENCPT"));			// 휴대전화번호암호화
			mapIns.put("TRPR_EML_ADDR_ENCPT", mapIns.get("TRPR_EML_ADDR_ENCPT"));	// 대상자이메일주소암호화
			mapIns.put("PIC_NM_ENCPT", mapIns.get("PIC_NM_ENCPT"));					// 담당자명암호화
			
			// insert
			bbscrsListMapper.insertBbscrsIndv(mapIns);		// AYA120[위기상담_개인] 
			bbscrsListMapper.insertCrisisBoard(mapIns);		// AYA110[위기상담_게시판]
			
			// 위기유형구분코드 update
			bbscrsListMapper.updateBbscrsIndv100(mapIns);	// AYE100[사이버상담게시글]			
...
//			System.out.println("mapUpd = "+mapUpd);
			...
			// data 암호화
			mapUpd.put("CLIENA_NM_ENCPT", mapUpd.get("CLIENA_NM_ENCPT"));			// 내담자명암호화
			mapUpd.put("MBL_TELNO_ENCPT", mapUpd.get("MBL_TELNO_ENCPT"));			// 휴대전화번호암호화
			mapUpd.put("TRPR_EML_ADDR_ENCPT", mapUpd.get("TRPR_EML_ADDR_ENCPT"));	// 대상자이메일주소암호화
			mapUpd.put("PIC_NM_ENCPT", mapUpd.get("PIC_NM_ENCPT"));					// 담당자명암호화
			
			// 화면 입력 내용 update
			bbscrsListMapper.updateBbscrsIndv(mapUpd);		// AYA120[위기상담_개인]
			// 위기유형구분코드 update
			bbscrsListMapper.updateBbscrsIndv100(mapUpd);	// AYE100[사이버상담게시글]
			bbscrsListMapper.updateCrisisBoard(mapUpd);		// AYA110[위기상담_게시판]
		...
		while (deletedRows.hasNext()) {			
			...
			bbscrsListMapper.deleteBbscrsIndv(mapDel);
			bbscrsListMapper.deleteBbscrsIndv100(mapDel);
		}
	...
	@Override
	public List<Map<String, Object>> selectBbscrsList7(Map<String, Object> mapParam) {
        List<Map<String, Object>> list = bbscrsListMapper.selectBbscrsList7(mapParam);
		return list;
	}
	
	@Override
	public List<Map<String, String>> selecClienaInfoList(Map<String, String> mapParam) {
		// TODO Auto-generated method stub
		return bbscrsListMapper.selecClienaInfoList(mapParam);
	}
	
	@Override
	public List<Map<String, String>> selecClienaInfoChttList(Map<String, String> mapParam) {
		// TODO Auto-generated method stub
		return bbscrsListMapper.selecClienaInfoChttList(mapParam);
	}
}
