 ...
 ******************************************************************************************/
package isry.couns.constt.bbsmcr.service;
 ...
 * -                
 */
public interface BbsmcrListService {
	...
	Map<String, Object> saveBbsmcrList(HttpServletRequest request, DataRequest dataRequest);
	
	Map<String, Object> saveBbsmcrAftList(HttpServletRequest request, DataRequest dataRequest);
