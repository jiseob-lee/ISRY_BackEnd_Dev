...
@Mapper("InqSpclaMapper")
public interface InqSpclaMapper {
	/**
	...
	void insertSpcla(Map<String, String> mapIns);

	void updateSpcla(Map<String, String> mapUpd);
	
	void deleteSpcla(Map<String, String> mapUpd);
	
	void saveClientName(Map<String, String> paramMap);
}
