...
@Mapper("bbscttListMapper")
public interface BbscttListMapper {
	...
	void insertBbsctt(Map<String, String> mapIns);
	
	void updateBbsctt(Map<String, String> mapUpd);
	
	void deleteBbsctt(Map<String, String> mapDel);

	int insertRespod(Map<String, String> mapIns);
	
	void updateRespod(Map<String, String> mapUpd);
	
	void updateRespod100(Map<String, String> mapUpd);
	...
	void updateBbscttRespod(Map<String, Object> mapAns);

	void RespodDtlCnt(Map<String, Object> mapParam);
	
	void insertVoc(Map<String, Object> mapParam);
	
	int selectVocCnt(Map<String, Object> mapParam);
	...
	Map<String, String> selectSrvyIndexSn(Map<String, String> map);
	
	Map<String, String> selectSrvyChttIndexSn(Map<String, String> map);
	
	List<Map<String, String>> selectEumSrvyResultList(Map<String, String> mapParam);
}
