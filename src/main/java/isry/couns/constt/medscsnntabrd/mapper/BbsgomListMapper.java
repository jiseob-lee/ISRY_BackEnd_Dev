...
@Mapper("bbsgomListMapper")
public interface BbsgomListMapper {
	...
	void updateBbsgom(Map<String, String> mapUpd);

	void insertBbsgom(Map<String, String> mapIns);
	
	void deleteBbsgom(Map<String, String> mapDel);
	
//	----------------------------------------------댓글
	
	List<Map<String, Object>> selectRplyDetail(Map<String, Object> mapParam) throws Exception;
	
	void updateRply(Map<String, String> mapUpd);

	void insertRply(Map<String, String> mapIns);
	
	void deleteRply(Map<String, String> mapDel);
