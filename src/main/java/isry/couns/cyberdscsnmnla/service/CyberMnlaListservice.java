...
public interface CyberMnlaListservice {
	...
	List<Map<String, Object>> selectCyberMnlaList(Map<String, Object> mapParam) throws Exception;
	
	Map<String, Object> saveCyberMnlaProc(HttpServletRequest request, DataRequest dataRequest);
