...
import isry.couns.cyberdscsnmnla.mapper.CyberMnlaListMapper;
...
@Service
public class CyberMnlaListServiceimpl implements CyberMnlaListservice {

	@Resource(name = "cyberMnlaListMapper")
	private CyberMnlaListMapper cyberMnlaListMapper;
	...
	public List<Map<String, Object>> clienaMnlaCode(String codeId) throws Exception {
		...
		return cyberMnlaListMapper.cyberMnlaCode(codeId);
	}
	
	@Override
	public List<Map<String, Object>> clienaMnlaCodeS(String codeId) throws Exception {
		// TODO Auto-generated method stub
		return cyberMnlaListMapper.cyberMnlaCodeS(codeId);
	}
	
	
	@Override
	public List<Map<String, Object>> selectInqCyberMnlaDetail(Map<String, Object> mapParam) throws Exception {
		// TODO Auto-generated method stub
		return cyberMnlaListMapper.selectInqCyberMnlaDetail(mapParam);
	}
	...
	@Override
	public Map<String, Object> saveCyberMnlaProc(HttpServletRequest request, DataRequest dataRequest) {
		...
		while (insertedRows.hasNext()) {
			...
			cyberMnlaListMapper.insertCyberMnlaReg(mapIns);
