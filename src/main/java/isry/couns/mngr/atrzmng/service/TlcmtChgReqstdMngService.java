...
public interface TlcmtChgReqstdMngService {
	
	List<Map<String, Object>> selectTlcmtChgReqstdMngList(HttpServletRequest request, Map<String, Object> mapParam) throws Exception;
