...
import isry.couns.mngr.consultantabltymng.mapper.AprslMngMapper;
import isry.couns.mngr.consultantabltymng.service.AprslMngService;
import isry.itgcms.sysmgmt.userlogin.vo.UserDetailsVO;

@Service("aprslMngService")
public class AprslMngServiceImpl extends IsryBaseServiceImpl implements AprslMngService {

	@Resource(name = "aprslMngMapper")
	private AprslMngMapper mapper;
