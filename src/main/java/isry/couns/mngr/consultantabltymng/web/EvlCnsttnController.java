...
@Controller
@Api(value = "EvlCnsttnController Controller")
@RequestMapping("/evlCnsttn")
public class EvlCnsttnController {

	protected Logger log = LoggerFactory.getLogger(this.getClass());

    @Resource(name = "evlCnsttnService")
    private EvlCnsttnService svc;

    @RequestMapping("/selectEvlCnsttnList.do")
    public View selectEvlCnsttnList(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest)
            throws Exception {
...
log.debug("DDD : "+ searchParam.toString());        
        ...
        List<Map<String, Object>> list = svc.selectEvlCnsttnList(mapParam);
