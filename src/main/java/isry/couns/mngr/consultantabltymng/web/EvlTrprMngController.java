...
@Controller
@Api(value = "EvlTrprMngController Controller")
@RequestMapping("/evlTrprMng")
public class EvlTrprMngController {

	protected Logger log = LoggerFactory.getLogger(this.getClass());

    @Resource(name = "evlTrprMngService")
    private EvlTrprMngService svc;

    @RequestMapping("/selectEvlTrprMngList.do")
    public View selectEvlTrprMngList(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest)
            throws Exception {
...
log.debug("DDD : "+ searchParam.toString());        
        ...
        List<Map<String, Object>> list = svc.selectEvlTrprMngList(mapParam);
