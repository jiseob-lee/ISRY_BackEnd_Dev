...
@Controller
@Api(value = "OvtiWorkEtxpyAplyMngController Controller")
@RequestMapping("/ovtiWorkEtxpyAplyMng")
public class OvtiWorkEtxpyAplyMngController {

	protected Logger log = LoggerFactory.getLogger(this.getClass());

    @Resource(name = "ovtiWorkEtxpyAplyMngService")
    private OvtiWorkEtxpyAplyMngService svc;

    @RequestMapping("/selectOvtiWorkEtxpyAplyMngList.do")
    public View selectOvtiWorkEtxpyAplyMngList(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest)
            throws Exception {
...
log.debug("DDD : "+ searchParam.toString());        
        ...
        List<Map<String, Object>> list = svc.selectOvtiWorkEtxpyAplyMngList(mapParam);	
    ...
    @RequestMapping("/selectOvtiWorkEtxpyAplyMngDetail.do")
    public View selectOvtiWorkEtxpyAplyMngDetail(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest)
            throws Exception {
...
log.debug("DDD : "+ searchParam.toString());        
        ...
        List<Map<String, Object>> list1 = svc.selectOvtiWorkEtxpyAplyMngDetail1(mapParam);
        List<Map<String, Object>> list2 = svc.selectOvtiWorkEtxpyAplyMngDetail2(mapParam);
        List<Map<String, Object>> list3 = svc.selectOvtiWorkEtxpyAplyMngDetail3(mapParam);
        List<Map<String, Object>> list4 = svc.selectOvtiWorkEtxpyAplyMngDetail4(mapParam);
