...
/**
 * @파일명 : ConQuestionStatsMapper.java
 * @프로그램 설명 : 상담설문통계(~080228) 통계를 관리하는 Mapper
 * @작성자 : kim.seong.gyu
 * @작성일 : 2022. 5. 04
 * @수정자 : 
 * @수정일 : 
 * @수정내용 : - -
 */
@Mapper("conQuestionStatsMapper")
public interface ConQuestionStatsMapper {
	...
	public List<Map<String, Object>> selectConsttSrvyStatsList(Map<String, Object> mapParam) throws Exception;
	
	public List<Map<String, Object>> selectConsttSrvyStatsList1(Map<String, Object> mapParam) throws Exception;
	...
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList05(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListANGR(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListUR(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListMOM(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListCAGIST(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList01(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList02(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList03(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList04(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList1117(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListKKKP(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListSS(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListKC(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListSC(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListLIFE(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList1(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultList2(Map<String, String> paramMap) throws Exception;
	
	public List<Map<String, Object>> selectWeposInspStatsDetailResultListElse(Map<String, String> paramMap) throws Exception;
	...
	public List<Map<String, Object>> selectLinkPrfmncStatsListCHTT1(Map<String, Object> mapParam) throws Exception;
	
	public List<Map<String, Object>> selectLinkPrfmncStatsListSECRE1(Map<String, Object> mapParam) throws Exception;
	
	public List<Map<String, Object>> selectLinkPrfmncStatsListLINK1(Map<String, Object> mapParam) throws Exception;
	
	public List<Map<String, Object>> selectLinkPrfmncStatsListSLRBT1(Map<String, Object> mapParam) throws Exception;
	
	public List<Map<String, Object>> selectLinkPrfmncStatsListOUTRC1(Map<String, Object> mapParam) throws Exception;
	...
	public List<Map<String, Object>> selectLinkPrfmncStatsListOpenChtt1(Map<String, Object> mapParam) throws Exception;
	...
	List<Map<String, Object>> selectInstList(Map<String, Object> mapParam) throws Exception;
}
