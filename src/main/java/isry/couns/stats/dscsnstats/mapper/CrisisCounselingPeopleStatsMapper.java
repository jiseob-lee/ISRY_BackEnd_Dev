...
/**
 * @파일명 : CrisisCounselingPeopleStatsMapper.java
 * @프로그램 설명 : 위기상담 유형별/상담자별 통계를 관리하는 Mapper
 * @작성자 : kim.seong.gyu
 * @작성일 : 2022. 5. 04
 * @수정자 : 
 * @수정일 : 
 * @수정내용 : - -
 */
@Mapper("crisisCounselingPeopleStatsMapper")
public interface CrisisCounselingPeopleStatsMapper {
