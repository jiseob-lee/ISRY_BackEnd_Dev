...
import isry.couns.stats.dscsnstats.mapper.TimeStatsMapper;
import isry.couns.stats.dscsnstats.service.TimeStatsService;

@Service
public class TimeStatsServiceImpl extends IsryBaseServiceImpl implements TimeStatsService {

	@Resource(name = "timeStatsMapper")
