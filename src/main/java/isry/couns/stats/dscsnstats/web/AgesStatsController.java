...
@Controller
@Api(value = "AgesStatsController Controller")
@RequestMapping("/agesStats")
public class AgesStatsController {

	protected Logger log = LoggerFactory.getLogger(this.getClass());

    @Resource(name = "agesStatsService")
    private AgesStatsService svc;
