 ...
 ******************************************************************************************/
package isry.couns.taskwkschmng.schprecon.mapper;
 ...
 * @수정내용 : - -
 */
@Mapper("workChgAplyMapper")
public interface workChgAplylMapper {
	...
	public int insertWorkChgAply(Map<String, String> mapParam) throws Exception;
	...
	public List<Map<String, Object>> selectWorkChgAplyChkList(Map<String, String> mapParam) throws Exception;
