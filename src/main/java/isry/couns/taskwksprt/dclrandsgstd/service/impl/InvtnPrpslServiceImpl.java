...
import isry.couns.taskwksprt.dclrandsgstd.mapper.InvtnPrpslMapper;
import isry.couns.taskwksprt.dclrandsgstd.service.InvtnPrpslService;
import isry.itgcms.sysmgmt.userlogin.vo.UserDetailsVO;

@Service("invtnPrpslService")
public class InvtnPrpslServiceImpl extends IsryBaseServiceImpl implements InvtnPrpslService {

	@Resource(name = "invtnPrpslMapper")
	private InvtnPrpslMapper mapper;
