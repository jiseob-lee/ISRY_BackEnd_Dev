 ...
 ******************************************************************************************/
package isry.csemd.cmmn.service;

import java.util.List;
import java.util.Map;

/**
 * @파일명 : CsemdService.java
 * @프로그램 설명 : - -
 * @작성자 : Lee.Hye.Sun
 * @작성일 : 2022. 9. 29.
 * @수정자 : Lee.Hye.Sun
 ...
 * @수정내용 : - -
 */
public interface CsemdService {

	List<Map<String, Object>> selectBizYrCmb(Map<String, String> requestMap) throws Exception;

	List<Map<String, Object>> selectInstCmb(Map<String, String> requestMap) throws Exception;

	List<Map<String, Object>> selectSrvcExcnBizCmb(Map<String, String> requestMap) throws Exception;
