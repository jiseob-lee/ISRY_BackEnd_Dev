 ...
 ******************************************************************************************/
package isry.csemd.mdlrtrehabcrsemng.hlngcmp.service;
 ...
 * @수정내용 : - -
 */
public interface HlngCmpService {

	List<Map<String, Object>> selectMentorList(Map<String, String> requestMap) throws Exception;

	List<Map<String, Object>> selectMenteeList(Map<String, String> requestMap) throws Exception;

	List<Map<String, Object>> selectMentorMenteeMatchingList(Map<String, String> requestMap) throws Exception;
