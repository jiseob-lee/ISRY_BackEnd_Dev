 ...
 ******************************************************************************************/
package isry.cysns.casemng.casetrmn.service;
 ...
 * -
 */
public interface CysnsTrmnService {

	public void saveData(HttpServletRequest request, DataRequest dataRequest) throws Exception;

	public List<Map<String, String>> selectProbmSttsById(DataRequest dataRequest) throws Exception; //문제상태
