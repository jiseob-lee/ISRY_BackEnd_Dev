 ...
 ******************************************************************************************/
package isry.cysns.tlphondscsn.tlphondscsn.service.impl;
...
import isry.cysns.tlphondscsn.tlphondscsn.mapper.TlphonDscsnMapper;
import isry.cysns.tlphondscsn.tlphondscsn.service.TlphonDscsnService;
 ...
 * -                
 */
@Service("tlphonDscsnService")
public class TlphonDscsnServiceImpl implements TlphonDscsnService {
	
	@Resource(name = "tlphonDscsnMapper")
	private TlphonDscsnMapper tlphonDscsnMapper; 
