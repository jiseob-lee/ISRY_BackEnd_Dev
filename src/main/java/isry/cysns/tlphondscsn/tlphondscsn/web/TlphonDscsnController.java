 ...
 ******************************************************************************************/
package isry.cysns.tlphondscsn.tlphondscsn.web;
 ...
 */
@Controller
@RequestMapping("/isry/cysns/tlphondscsn/tlphondscsn")
public class TlphonDscsnController {
	
	//private Logger log = LoggerFactory.getLogger(this.getClass());

	@Resource(name = "tlphonDscsnService")
	private TlphonDscsnService tlphonDscsnService;
