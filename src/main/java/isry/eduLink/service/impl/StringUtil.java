...
/**
     ...
     * @see
     */    
    public static String telAsterisk(String srcString) {
    	...
    	if (tmpLength == 10) {
			tmpString1 = tmpString.substring(0, 3);
			tmpString1 = tmpString1 + "***" + tmpString.substring(6);
		} else if (tmpLength == 11) {
			tmpString1 = tmpString.substring(0, 3);
			tmpString1 = tmpString1 + "***" + tmpString.substring(6);
		} else if (tmpLength == 9) {
			tmpString1 = tmpString.substring(0, 2);
			tmpString1 = tmpString1 + "***" + tmpString.substring(5);
		} else {
			tmpString1 = "-";
		}
     ...
     * @see
     */    
    public static String ipAsterisk(String srcString) {
    	
    	String tmpString = srcString;
    	
//    	System.out.println("srcString========="+srcString);
    	
    	String reStr =ipreplace(tmpString);
    	
    	String tmpString2="-";
    	
//    		System.out.println("reStr========="+reStr);
//    		System.out.println("reStr.length()"+reStr.length());
    		if(reStr.length() != 0){
    	    	String[] tmpStr = reStr.split("[.]");
/*
    	    	for(int i=0; i<tmpStr.length;i++){
    	    		System.out.println(tmpStr.length+"tmpStr["+i+"]====="+tmpStr[i]);
    	    		if(tmpStr.length-1 ==i){
    	    			System.out.println("====================================");
    	    		}
    	    	}
*/
    	    	tmpString2= tmpStr[0]+".***.***."+tmpStr[3];
    		}

		return  tmpString2;
	}
    
    public static String ipreplace(String srcString) {
    	String ret = srcString;
    	
    	if("0.0.0.0".equals(ret)){
    		ret = srcString.replace("0.0.0.0", "");
    	}
     ...
     * @see
     */    
    public static String macAsterisk(String srcString) {
		...
		if(tmpString != null && tmpString != ""){
	    	tmpString1 = tmpString.split("-");
	    	tmpString2= "**-**-**-"+tmpString1[3]+"-"+tmpString1[4]+"-"+tmpString1[5];    			
		}
     ...
     * @see
     */    
    public static String datReplace(BigDecimal srcString) {
    	
    	String tmpString = srcString.toString();
    	
		if(tmpString != null && tmpString != ""){
			if(tmpString.length()==18 ){
				tmpString = tmpString.substring(0, 4)+"."
				          + tmpString.substring(4, 6)+"."
				          + tmpString.substring(6, 8)+" "
				          + tmpString.substring(8, 10)+":"
				          + tmpString.substring(10, 12);
			}
		}
