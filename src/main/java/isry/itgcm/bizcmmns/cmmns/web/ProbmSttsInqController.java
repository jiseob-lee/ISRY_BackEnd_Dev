...
/**
 * @파일명        : ProbmSttsInqController.java
...
public class ProbmSttsInqController {
	...
	@Resource(name = "probmSttsInqService")
	private ProbmSttsInqService probmSttsInqService;
	 ...
	 */
	@RequestMapping(value = "/selectProbmSttsInqOnload.do")
	public View selectProbmSttsCasOnload(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest) throws Exception{
	 ...
	 * @작성일     	: 2022. 05. 11. 
 	 */	
	@RequestMapping(value = "/selectProbmSttsInqList.do")
	public View selectSrvcResrceClList(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest) throws Exception {
		...
		List<Map<String, Object>> list = probmSttsInqService.selectProbmSttsInqList(dataRequest);
