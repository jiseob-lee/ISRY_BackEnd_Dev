...
/**
* @Class Name  : SrvcResrcePopController.java
* @Description : 자원제공서비스목록(팝업) Controller Class
*
* @author  : Seo.Hae.Seok
* @since   : 2022. 05. 11.
* @version : 1.0
...
public class SrvcResrcePopController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(EgovProperties.class);
	
	@Resource(name = "srvcResrcePopService")
	private SrvcResrcePopService srvcResrcePopService;
	 ...
	 * @작성일     : 2022. 05. 11. 
 	 */	
	@RequestMapping(value = "/selectSrvcResrceList.do")
	public View selectSrvcResrceList(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest) throws Exception {
		
		// List<Map<String, Object>> list = srvcResrcePopService.selectSrvcResrceList(request, dataRequest);
		
		Map<String, Object> result = srvcResrcePopService.selectSrvcResrcePagingList(request, dataRequest);
		dataRequest.setResponse("dsList", result.get("list"));
