...
/**
 * @파일명 : ItgAimnsBrdController.java
 * @프로그램 설명 : 내일배움-한국생산성본부 게시판
 * @작성자 : You Minsang
 * @작성일 : 2022. 7. 15.
 * @수정자 : You Minsang
 * @수정일 : 2022. 7. 15.
 ...
 */
@Controller
@Api(value = "integrate Aimns Board Controller")
@RequestMapping("/itgAimnsBrd")
public class ItgAimnsBrdController {
	...
	@RequestMapping("/initItgAimnsBrd.do")
	...
	@RequestMapping("/onLoadItgAimnsBrd.do")
...
//		dataRequest.setResponse("dsCmbInstCd", listInstCode);
	...
	@RequestMapping("/listItgAimnsBrd.do")
	public View list(HttpServletRequest request, HttpServletResponse response, DataRequest dataRequest)
		...
		// 게시판 목록 데이터 조회(중요공지)
		List<Map<String, Object>> listItgNtcBoard = itgBrdCmnService.selectItgCmnBrdImprtnList(mapParam);
	...
	@RequestMapping("/deleteItgAimnsBrd.do")
	...
	@RequestMapping("/dtlListItgAimnsBrd.do")
	...
	@RequestMapping("/dtlSaveItgAimnsBrd.do")
	...
	@RequestMapping("/dtlCmntSaveItgAimnsBrd.do")
