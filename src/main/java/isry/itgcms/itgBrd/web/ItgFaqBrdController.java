 ...
 */
@Controller
@Api(value = "integrate FAQ Board Controller")
@RequestMapping("/itgFaqBrd")
public class ItgFaqBrdController {
	...
	@RequestMapping("/initItgFaqBrd.do")
	...
	@RequestMapping("/onLoadItgFaqBrd.do")
...
//		dataRequest.setResponse("dsCmbInstCd", listInstCode);	
	...
	@RequestMapping("/listItgFaqBrd.do")
	...
	@RequestMapping("/deleteItgFaqBrd.do")
	...
	@RequestMapping("/dtlListItgFaqBrd.do")
	...
	@RequestMapping("/dtlSaveItgFaqBrd.do")
