...
@RequestMapping("/itgNtcBrd")
public class ItgNtcBrdController {
	...
	@RequestMapping("/initItgNtcBrd.do")
	...
	@RequestMapping("/onLoadItgNtcBrd.do")
...
//		dataRequest.setResponse("dsCmbInstCd", listInstCode);
	...
	@RequestMapping("/listItgNtcBrd.do")
	...
	@RequestMapping("/deleteItgNtcBrd.do")
	...
	@RequestMapping("/dtlListItgNtcBrd.do")
	...
	@RequestMapping("/dtlSaveItgNtcBrd.do")
