 ...
 */
@Controller
@Api(value = "integrate Region Notice Board Controller")
@RequestMapping("/itgRgnBrd")
public class ItgRgnBrdController {
	...
	@RequestMapping("/initItgRgnBrd.do")
	...
	@RequestMapping("/onLoadItgRgnBrd.do")
...
//		dataRequest.setResponse("dsCmbInstCd", listInstCode);
	...
	@RequestMapping("/listItgRgnBrd.do")
	...
	@RequestMapping("/deleteItgRgnBrd.do")
	...
	@RequestMapping("/dtlListItgRgnBrd.do")
	...
	@RequestMapping("/dtlSaveItgRgnBrd.do")
