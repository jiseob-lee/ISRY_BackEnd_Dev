 ...
 ******************************************************************************************/
package isry.itgcms.syscmmn.rsvtmng.mapper;
 ...
 * -                
 */
@Mapper("rsvtMngMapper")
public interface RsvtMngMapper {
	 ...
	 * @Method설명 :
	 */
	List<Map<String, Object>> selectDailyPopUpList(Map<String, String> mapParam) throws Exception;
