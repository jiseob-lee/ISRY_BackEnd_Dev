...
/**
 * @파일명        : LongTermNotConnectedJob.java
 * @프로그램 설명 :
 * - 
 * - 
 * @작성자        : Lee.Ji.Seob
 ...
 * -                
 */
public class LongTermNotConnectedJob extends QuartzJobBean {
	...
	public void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		log.info("#### execute LongTermNotConnectedJob.");
		...
		LongTermNotConnectedService systemLogService = (LongTermNotConnectedService)appCtx.getBean(LongTermNotConnectedService.class);
		...
		try {
			systemLogService.updateCutOffLongTermNotConnected();
		} catch (IOException e) {
		...
		log.info("#### done LongTermNotConnectedJob.");
	}
