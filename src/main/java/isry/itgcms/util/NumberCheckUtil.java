...
public class NumberCheckUtil {
	...
	/**
	 * 
	 * @Method명   : checkJuminNumber
	 * @param jumin1 6자리 주민앞번호 문자열
	 * @param jumin2 7자리 주민뒷번호 문자열
	 * @return 유효한 번호인지 여부 (True/False)
	 * @작성자     : Lee.Ji.Seob
	 * @작성일     : 2023. 3. 9. 
	 * @Method설명 : 주민등록번호와 외국인등록번호 유효성 동시 체크
	 */
     ...
     */
    public static boolean checkJuminNumberOnly(String jumin1, String jumin2) {
    	
    	//DateUtil egovDateUtil = new DateUtil();
