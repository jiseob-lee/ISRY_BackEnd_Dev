 ...
 ******************************************************************************************/
package isry.pubmsr.casemng.recvryreg.mapper;
 ...
 * -                
 */
@Mapper("recvryRegMapper")
public interface RecvryRegMapper {
	...
	public void deleteAllData(Map<String, String> map) throws Exception;
