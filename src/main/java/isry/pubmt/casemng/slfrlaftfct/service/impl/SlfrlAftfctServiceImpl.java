 ...
 ******************************************************************************************/
package isry.pubmt.casemng.slfrlaftfct.service.impl;
...
import isry.pubmt.casemng.slfrlaftfct.mapper.SlfrlAftfctMapper;
 ...
 * -                
 */
@Service("slfrlAftfctService")
public class SlfrlAftfctServiceImpl implements SlfrlAftfctService{
	
	@Resource(name = "slfrlAftfctMapper")
	private SlfrlAftfctMapper slfrlAftfctMapper;
	...
	public void processCaseEsntalRegString(HttpServletRequest request, String sCaseMngNo, String sCaseMngOdrno, String sNewCaseMngOdrno) throws Exception {
		...
		slfrlAftfctMapper.saveCaseInfoData(paramMap);
