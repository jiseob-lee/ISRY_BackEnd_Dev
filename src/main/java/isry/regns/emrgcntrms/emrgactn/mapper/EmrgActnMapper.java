 ...
 ******************************************************************************************/
package isry.regns.emrgcntrms.emrgactn.mapper;
 ...
 * -                
 */
@Mapper("emrgActnMapper")
public interface EmrgActnMapper {
	...
	public List<Map<String, String>> selectEmrgRptById(String param) throws Exception;
	
	public void saveData(Map<String, String> map) throws Exception;
	public void deleteData(String param) throws Exception;
	public void deleteDtlData(Map<String, String> paramMap) throws Exception;
