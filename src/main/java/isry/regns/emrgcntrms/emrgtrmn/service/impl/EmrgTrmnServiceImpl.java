 ...
 ******************************************************************************************/
package isry.regns.emrgcntrms.emrgtrmn.service.impl;
...
import isry.regns.emrgcntrms.emrgtrmn.mapper.EmrgTrmnMapper;
 ...
 * -                
 */
@Service("emrgTrmnService")
public class EmrgTrmnServiceImpl implements EmrgTrmnService{
	
	@Resource(name = "emrgTrmnMapper")
	private EmrgTrmnMapper emrgTrmnMapper;
	...
	public Map<String, String> selectKeyValue(HttpServletRequest request, DataRequest dataRequest) throws Exception {
		...
		mngNoMap.put("EMRG_CNTRMS_TRMN_NO", emrgTrmnMapper.selectKeyValue(userId));
...
//		UserDetailsVO loginVO = userLoginService.getLoginSessionVO(request);
		...
		List<Map<String, String>> selectList = emrgTrmnMapper.selectReqList(paramMap2);
	...
	public List<Map<String, String>> selectReqById(DataRequest dataRequest) throws Exception {
		...
		ParameterGroup param = dataRequest.getParameterGroup("dmListParam");
		String mngNo = param.getValue("EMRG_CNTRMS_TRMN_NO");

		List<Map<String, String>> result = emrgTrmnMapper.selectReqById(mngNo);
	...
	public void saveData(HttpServletRequest request, DataRequest dataRequest) throws Exception {
		...
		for (Map<String, String> map : deletedRowList) {
			String mngNo = map.get("EMRG_CNTRMS_TRMN_NO");
			emrgTrmnMapper.deleteData(mngNo);
		}
