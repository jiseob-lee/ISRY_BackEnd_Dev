 ...
 ******************************************************************************************/
package isry.regns.operorgnzt.linkinst.mapper;
 ...
 * -                
 */
@Mapper("linkInstMapper")
public interface LinkInstMapper {
	
	public List<Map<String, String>> selectReqList(Map<String, Object> paramMap) throws Exception;
	public List<Map<String, String>> selectYngbgsSurgList(Map<String, Object> paramMap) throws Exception;
