 ...
 ******************************************************************************************/
package isry.uneartmng.policelinkaply.mapper;
...
public interface PicMngMapper {
	...
	public List<Map<String, Object>> selectOfcdcPicList(Map<String, String> map) throws Exception;
	public List<Map<String, Object>> selectPolicePicList(Map<String, String> map) throws Exception;
}
