 ...
 * @수정내용 : - -
 */
@Mapper("aplcntTrprMng2Mapper__admin")
public interface AplcntTrprMng2Mapper {
	...
	public List<Map<String, String>> selectSmsList(Map<String, Object> paramMap) throws Exception;
}
