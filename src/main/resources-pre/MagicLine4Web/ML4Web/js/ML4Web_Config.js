...
var ConfigObject = {
    ...
    STORAGELIST_LNB             : ["share","finance_user"], //왼쪽날개창 여부 값. ["share","finance","finance_user","finance_corp"] : 공동인증서, 통합 금융인증서, 개인 금융인증서, 사업자 금융인증서 ([]:off)
    ...
    // gov.youthsafety.go.kr|pre.youthsafety.go.kr|youthsafety.go.kr|localhost|127.0.0.1
    AuthKey                     : "XiXRSBTw21bX8nHVVbc0FPjUejskfV2bL/xBQQM1+zqqf7gDR1MB5shG4R96EgtoHIZK1sHzOV8w7/p0+vUkyUt5C9BnE982PnMiiB/HomE50d+jy8ObE7e+4l2k77/hpY9AilEmU4jmynWZgFFk7g==",
