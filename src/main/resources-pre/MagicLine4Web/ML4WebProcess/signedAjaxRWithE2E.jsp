...
<%
	...
	String sEncData = request.getParameter("sign");
	String division = "`"; // 구분자
	...
	if (sEncData != null && sEncData.length() > 0 && ml != null){
		...
		if( sDecryptResult != 0){
			System.out.println("error check init");
			out.println("error check init");
		}else{
			plain = java.net.URLDecoder.decode((String)sbPlain.toString(),"utf-8").split(division);
