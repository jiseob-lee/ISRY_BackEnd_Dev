...
<div id="ML_window" style="display:none;">
	...
	<div id="ML_container" style="width:526px; float:left;"><!-- ML_container : S -->
		...
		<div class="ML_content" style="display:inline-block;width:418px;"><!-- ML_content : S -->
		    <!-- 20221108 금융인증서 안내 UI 추가 S -->
			    <div class="ML_content-area" id="Fcert" style="display:none;">
			        <div class="Fcert_info_wrap">
			            <p>인증서 사용안내</p>
			            <div class="Fcert_info_txt">금융인증서 사용을 위해<br> 아래 버트을 클릭하여 팝업창을 열어주세요</div>
			            <!-- BTN -->
			            <span class="btn_row">
			                <p class="b_blue_btn"><button type="button" name="okBtn" id=okBtn onClick="finance_btnClick()"><span>금융인증서 열기</span></button></p>
			            </span> 
			            <!-- BTN -->
			        </div>
			    </div>
<!--     20221108 금융인증서 안내 UI 추가 E
			<div class="ML_content-area" id="MagicLine_finance" style="display:none; padding-top:5px;">ML_content-area : S (finance)
				<div class="ML_finance_tit">
					<span>인증서 사용안내</span>
				</div>
				<div class="ML_finance_con1">
					<span>금융인증서 사용을 위해</span>
				</div>
				<div class="ML_finance_con2">
					<span>아래 버튼을 클릭하여 팝업창을 열어주세요</span>
				</div>
				<div class="ML_finance_btn">
					<button id="finance_btn">금융인증서 열기</button>
				</div>
			</div> -->
			<div class="ML_content-area" id="MagicLine" style="padding-top:5px;"><!-- ML_content-area : S -->
			<div id='ESignWindow'></div>
				<div class="ML_cp_AD" style="display:;">
					<img id="banner" src="UI/images/ML5_banner.png"  alt="MagicLine4Web 인증서 선택창 로고">
				</div>
					...
					<div class="ML_pw_area">
						<div class="ML_cert_pw_area">
							<span class="ML_cert_pw_field">
								...
								<input type="password" id="input_cert_pw" name="input_cert_pw" class="passwd_input" ds-kb-type="qwerty" ds-kb-focus="check" ds-kb-xy="[-100, 0]" data-tk-kbdType="qwerty" title="인증서 비밀번호 입력" placeholder="비밀번호를 입력하시오." autocomplete="off" value="" onKeypress="signEnterKeyEvent(event)" npkencrypt="on" data-keypad-type="alpha" data-keypad-theme="default" data-keypad-useyn-type="toggle" data-keypad-useyn-input="keyboardOn" />
			...
			<div class="ML_content-area" id="MagicLine_lnb" style="padding-top:5px; display:none;"><!-- ML_content-area : S -->
			</div><!-- ML_content-area : E -->
