...
function displayMap(psAddrs, yDnts, xDnts) {

    console.log("dispalyMap === 시작 =====");
    console.log("yDnts : ", yDnts);
    console.log("xDnts : ", xDnts);
    
    kakao.maps.load(function() {
        var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
        mapOption = {
//            center: new kakao.maps.LatLng(33.450701, 126.570667), // 지도의 중심좌표
            center: new kakao.maps.LatLng(yDnts, xDnts), // 지도의 중심좌표
            level: 11 // 지도의 확대 레벨
        };  
