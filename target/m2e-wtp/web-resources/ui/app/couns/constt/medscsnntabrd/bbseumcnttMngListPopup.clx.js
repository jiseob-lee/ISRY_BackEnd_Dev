/*
 * App URI: app/couns/constt/medscsnntabrd/bbseumcnttMngListPopup
 * Source Location: app/couns/constt/medscsnntabrd/bbseumcnttMngListPopup.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/couns/constt/medscsnntabrd/bbseumcnttMngListPopup", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_2.parseData({
				...
				"rows": [{"CMMNS_ID": "CNCT_NTABRD_CTGRYB_SE_CD", "DS_NAME": "dsCnctNtabrdCtgrybSeCd"}]
			});
			app.register(dataSet_2);
			
			var dataSet_3 = new cpr.data.DataSet("dsCnctNtabrdCtgrybSeCd");
			dataSet_3.parseData({
				"columns" : [
					{"name": "CMMNS_CD_VALUE"},
					{"name": "CMMNS_CD_VALUE_NM"},
			...
			submission_1.action = "/bbseumList/eumContentList.do";
			submission_1.addRequestData(dataMap_1);
			submission_1.addResponseData(dataSet_1, false);
			app.register(submission_1);
			
			var submission_2 = new cpr.protocols.Submission("subSave");
			submission_2.action = "/bbseumList/eumContentInsert.do";
			...
			(function(container){
				...
				formLayout_2.setColumns(["293px", "260px", "1fr"]);
				...
				(function(container){
					...
					(function(container){
						...
						comboBox_1.fieldLabel = "이음카테고리구분";
						comboBox_1.preventInput = true;
						comboBox_1.userAttr({"required": "Y"});
						comboBox_1.bind("value").toDataMap(app.lookup("dmSearch"), "CNCT_NTABRD_CTGRYB_SE_CD");
						(function(comboBox_1){
							comboBox_1.setItemSet(app.lookup("dsCnctNtabrdCtgrybSeCd"), {
					...
					(function(container){
						var output_2 = new cpr.controls.Output("optAvrgDgstfnScore");
						output_2.value = "이음회기관리번호";
						...
						var comboBox_2 = new cpr.controls.ComboBox("cmbCysnetInptYn3");
						comboBox_2.fieldLabel = "이음회기관리번호";
						comboBox_2.preventInput = true;
						comboBox_2.userAttr({"required": "Y"});
						comboBox_2.bind("value").toDataMap(app.lookup("dmSearch"), "SESN_MNG_NO");
						(function(comboBox_2){
				...
				formLayout_5.setColumns(["293px", "260px", "1fr"]);
				...
				(function(container){
					...
					(function(container){
						var output_3 = new cpr.controls.Output("optSupvSlctnCaseYn");
						output_3.value = "이음페이지번호";
						...
						(function(container){
							...
							inputBox_1.bind("value").toDataMap(app.lookup("dmSearch"), "CNCT_PAGE_SN");
			...
			(function(container){
				...
				var group_10 = new cpr.controls.Container("grpForm");
				...
				(function(container){
					...
					formLayout_11.setColumns(["400px", "1fr"]);
