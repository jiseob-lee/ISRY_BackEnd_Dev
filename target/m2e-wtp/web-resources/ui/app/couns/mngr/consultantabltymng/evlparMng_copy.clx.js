/*
 * App URI: app/couns/mngr/consultantabltymng/evlparMng_copy
 * Source Location: app/couns/mngr/consultantabltymng/evlparMng_copy.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/couns/mngr/consultantabltymng/evlparMng_copy", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : evlparMng_copy.js
			 * @프로그램명 :  
			 * @작성자 : Jeong.Won.Je
			 * @작성일자: 2022. 2. 14. 오후 1:45:10
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			...
			(function(container){
				...
				(function(container){
					...
					(function(comboBox_1){
						...
						comboBox_1.addItem(new cpr.controls.Item("2021", "value2"));
						comboBox_1.addItem(new cpr.controls.Item("2020", "value3"));
					})(comboBox_1);
					...
					(function(comboBox_2){
						...
						comboBox_2.addItem(new cpr.controls.Item("동료 상담원", "value3"));
					})(comboBox_2);
					...
					(function(comboBox_3){
						comboBox_3.addItem(new cpr.controls.Item("선택", "value1"));
						comboBox_3.addItem(new cpr.controls.Item("1회차", "value2"));
						comboBox_3.addItem(new cpr.controls.Item("2회차", "value3"));
					})(comboBox_3);
