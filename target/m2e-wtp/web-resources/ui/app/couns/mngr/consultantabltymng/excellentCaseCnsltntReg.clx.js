/*
 * App URI: app/couns/mngr/consultantabltymng/excellentCaseCnsltntReg
 * Source Location: app/couns/mngr/consultantabltymng/excellentCaseCnsltntReg.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/couns/mngr/consultantabltymng/excellentCaseCnsltntReg", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			//    var voDsMapList = app.lookup("dsExclncCaseConsttList");
			//    
			////    for(var i=0; i<oRow; i++){
			////        console.log("dsExclncCaseConsttList ::::::::::: " + app.lookup("dsExclncCaseConsttList").getValue(oRow, "CHK")); 
			////        
			////        voDsMapList.setValue(i, "CONSTT_ID", app.lookup("dsExclncCaseConsttList").getValue(oRow, "CONSTT_ID"));         
			////        voDsMapList.setValue(i, "CONSTT_NM", app.lookup("dsExclncCaseConsttList").getValue(oRow, "CONSTT_NM"));
			////        voDsMapList.setValue(i, "DEPT_CD", app.lookup("dsExclncCaseConsttList").getValue(oRow, "DEPT_CD"));
			////        voDsMapList.setValue(i, "RLVT_YR", app.lookup("dmSearch").getValue("RLVT_YR"));
			////    }
			    ...
			    console.log("doSave ::::: " + app.lookup("dsExclncCaseConsttList").getRowCount());    
			    
			    // 저장 서브미션 호출
			    util.Submit.send(app, "subSaveExclncCaseConstt", function(pbSuccess){
			        if(pbSuccess){
			...
			function onBodyLoad(/* cpr.events.CEvent */ e){
				...
				if(voInitValue){
			        ...
			        // 조회 서브미션 호출
			        util.Submit.send(app, "subExclncCaseConsttList", function(pbSuccess){
			            if(pbSuccess){
			                //조회되었습니다.
			                util.Msg.notify(app, "INF-M001");                
			...
			//    var oDsList = app.lookup("dsExclncCaseConsttList");
			//    
			//    grd1.setCheckRowIndex(vnRowIdx, true);
			//    
			////    oDsList.setValue(vnRowIdx, "CHK", true);
			//    console.log(oDsList.getValue(vnRowIdx, "CHK"));
			//    
			//}
			...
			//    var oDsList = app.lookup("dsExclncCaseConsttList");
			//        
			//    grd1.setCheckRowIndex(vnRowIdx, '');        
			////    oDsList.setValue(vnRowIdx, "CHK", '');
			//    console.log(oDsList.getValue(vnRowIdx, "CHK"));  
			//    
			//}
			...
			function onBtn2Click(e){
			    ...
			    var findList = app.lookup("dsExclncCaseConsttList").findAllRow("CHK == ''");
			...
			function onBtn4Click(e){
			    ...
			    var findList = app.lookup("dsExclncCaseConsttList").findAllRow("CHK == 'true'");
			    console.log(findList);
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsExclncCaseConsttList");
			dataSet_1.parseData({
				"columns" : [
					{"name": "CHK"},
					{"name": "CONSTT_ID"},
			...
			var submission_1 = new cpr.protocols.Submission("subExclncCaseConsttList");
			submission_1.action = "/isry/couns/mngr/consultantabltymng/subExclncCaseConsttList.do";
			submission_1.addRequestData(dataMap_1);
			submission_1.addResponseData(dataSet_1, false);
			app.register(submission_1);
			
			var submission_2 = new cpr.protocols.Submission("subSaveExclncCaseConstt");
			submission_2.action = "/isry/couns/mngr/consultantabltymng/subSaveExclncCaseConstt.do";
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_2.title = "우수사례 상담자등록";
					...
					formLayout_2.setColumns(["32px", "1fr"]);
				...
				(function(container){
					...
					grid_1.init({
						"dataSet": app.lookup("dsExclncCaseConsttList"),
						"columns": [
							{"width": "50px"},
							{"width": "80px"},
							{"width": "100px"},
