/*
 * App URI: app/couns/stats/etcstats/connGraphStats
 * Source Location: app/couns/stats/etcstats/connGraphStats.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/couns/stats/etcstats/connGraphStats", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : connGraphStats.js
			 * @프로그램명 :  
			 * @작성자 : Kang.Hwa.Young
			 * @작성일자: 2022. 3. 28. 오후 12:55:13
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_4.title = "접속통계 그래프";
