/*
 * App URI: app/couns/taskwkschmng/schprecon/schdlCmmns_dtl
 * Source Location: app/couns/taskwkschmng/schprecon/schdlCmmns_dtl.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/couns/taskwkschmng/schprecon/schdlCmmns_dtl", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : schdlCmmns_dtl.js
			 * @프로그램명 :  
			 * @작성자 : Jeong.Won.Je
			 * @작성일자: 2022. 2. 10. 오후 5:35:30
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			...
			(function(container){
				...
				(function(container){
					var output_1 = new cpr.controls.Output("optWorkYmd");
					output_1.value = "일정날자";
					...
					output_2.value = "2022년 02월 03일";
					container.addChild(output_2, {
						"colIndex": 1,
						"rowIndex": 0
					});
					var output_3 = new cpr.controls.Output("optBgngHr");
					output_3.value = "상담시간";
					...
					output_4.value = "17: 30 ~ 21:30";
					container.addChild(output_4, {
						"colIndex": 1,
						"rowIndex": 1
					});
					var output_5 = new cpr.controls.Output("optCnsltntNm");
					output_5.value = "이름";
					...
					var output_7 = new cpr.controls.Output("optCnsltntId");
					output_7.value = "아이디";
