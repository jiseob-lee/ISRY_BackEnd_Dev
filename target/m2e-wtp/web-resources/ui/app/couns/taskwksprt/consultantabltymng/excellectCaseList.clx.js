/*
 * App URI: app/couns/taskwksprt/consultantabltymng/excellectCaseList
 * Source Location: app/couns/taskwksprt/consultantabltymng/excellectCaseList.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/couns/taskwksprt/consultantabltymng/excellectCaseList", { 
			...
			(function(container){
				...
				(function(container){
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											output_5.bind("value").toDataColumn("미제출");
											return output_5;
										})();
									}
								},
					...
					(function(container){
						...
						userDefinedControl_4.title = "우수사례";
						container.addChild(userDefinedControl_4, {
							"colIndex": 0,
							"rowIndex": 0
						});
						var output_7 = new cpr.controls.Output("opt7");
						output_7.value = "[양식]우수사례 제출.hwp";
						output_7.style.css({
							"text-align" : "right"
						});
