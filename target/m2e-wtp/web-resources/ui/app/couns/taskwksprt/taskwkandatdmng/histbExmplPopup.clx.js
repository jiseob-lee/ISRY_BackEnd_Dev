/*
 * App URI: app/couns/taskwksprt/taskwkandatdmng/histbExmplPopup
 * Source Location: app/couns/taskwksprt/taskwkandatdmng/histbExmplPopup.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/couns/taskwksprt/taskwkandatdmng/histbExmplPopup", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : histbExmplPopup.js
			 * @프로그램명 :  
			 * @작성자 : Jeong.Won.Je
			 * @작성일자: 2022. 7. 20. 오후 2:00:18
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			function onBodyLoad(/* cpr.events.CEvent */ e){
			    ...
			    console.log("voInitValue : ", voInitValue.selectedRowData);
			    if(voInitValue.selectedRowData){
			        var selectedRowData = voInitValue.selectedRowData;
			        console.log("CHTT_DSCSN_CN : ", selectedRowData.CHTT_DSCSN_CN);
			        
			//        app.lookup("dmSearch").setValue("CHTT_DSCSN_CN",selectedRowData.CHTT_DSCSN_CN);
			        app.lookup("cmnAutoHeightTextarea1").value = selectedRowData.CHTT_DSCSN_CN;
