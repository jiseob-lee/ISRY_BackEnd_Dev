/*
 * App URI: app/cysns/casemng/trlinsp/charctinsp/trlInspResult_0101
 * Source Location: app/cysns/casemng/trlinsp/charctinsp/trlInspResult_0101.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/cysns/casemng/trlinsp/charctinsp/trlInspResult_0101", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// 심리검사결과중분류구분코드
			var trlInspResultMlsfcSeCd = '0101';
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_2.setColumns(["100px", "1fr", "1fr", "1fr", "1fr", "1fr", "1fr", "1fr", "1fr", "1fr", "1fr"]);
					...
					(function(container){
						...
						if(typeof onOpt22ValueChange == "function") {
							output_12.addEventListener("value-change", onOpt22ValueChange);
						}
						...
						inputBox_11.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 0);
						...
						inputBox_12.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 1);
						...
						inputBox_13.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 2);
						...
						inputBox_14.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 3);
						...
						inputBox_15.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 4);
						...
						inputBox_16.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 5);
						...
						inputBox_17.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 6);
						...
						inputBox_18.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 7);
						...
						inputBox_19.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 8);
						...
						inputBox_20.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 9);
					...
					group_4.fieldLabel = "성격검사 - 표준화 성격검사";
					...
					formLayout_3.setColumns(["100px", "1fr", "1fr", "1fr", "1fr", "1fr", "1fr"]);
					...
					(function(container){
						...
						var inputBox_21 = new cpr.controls.InputBox("ipb10");
						inputBox_21.maxLength = 10;
						inputBox_21.style.css({
							"text-align" : "center"
						});
						inputBox_21.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 10);
						...
						inputBox_22.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 11);
						...
						inputBox_23.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 12);
						...
						inputBox_24.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 13);
						...
						inputBox_25.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 14);
						...
						inputBox_26.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 15);
						container.addChild(inputBox_26, {
							"colIndex": 6,
							"rowIndex": 1
						});
						var inputBox_27 = new cpr.controls.InputBox("ipb31");
						inputBox_27.maxLength = 10;
						inputBox_27.style.css({
							"text-align" : "center"
						});
						inputBox_27.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 10);
						container.addChild(inputBox_27, {
							"colIndex": 1,
							"rowIndex": 2
						});
						var inputBox_28 = new cpr.controls.InputBox("ipb32");
						inputBox_28.maxLength = 10;
						inputBox_28.style.css({
							"text-align" : "center"
						});
						inputBox_28.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 11);
						...
						inputBox_29.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 12);
						...
						inputBox_30.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 13);
						...
						inputBox_31.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 14);
						...
						inputBox_32.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 15);
