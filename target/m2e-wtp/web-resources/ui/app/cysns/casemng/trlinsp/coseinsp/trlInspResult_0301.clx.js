/*
 * App URI: app/cysns/casemng/trlinsp/coseinsp/trlInspResult_0301
 * Source Location: app/cysns/casemng/trlinsp/coseinsp/trlInspResult_0301.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/cysns/casemng/trlinsp/coseinsp/trlInspResult_0301", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// 심리검사결과중분류구분코드
			var trlInspResultMlsfcSeCd = '0301';
			...
			(function(container){
				...
				(function(container){
					...
					group_3.fieldLabel = "진로검사 - 적성탐색검사";
					...
					formLayout_3.setColumns(["1fr", "1fr", "1fr", "1fr", "1fr", "1fr", "1fr"]);
					...
					(function(container){
						...
						inputBox_7.fieldLabel = "관습형";
						inputBox_7.maxLength = 10;
						inputBox_7.style.css({
							"text-align" : "center"
						});
						inputBox_7.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 11);
						container.addChild(inputBox_7, {
							"colIndex": 6,
							"rowIndex": 1
						});
						var inputBox_8 = new cpr.controls.InputBox("ipb8");
						inputBox_8.fieldLabel = "기업형";
						inputBox_8.maxLength = 10;
						inputBox_8.style.css({
							"text-align" : "center"
						});
						inputBox_8.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 10);
						container.addChild(inputBox_8, {
							"colIndex": 5,
							"rowIndex": 1
						});
						var inputBox_9 = new cpr.controls.InputBox("ipb9");
						inputBox_9.fieldLabel = "사회형";
						...
						inputBox_10.fieldLabel = "예술형";
						inputBox_10.maxLength = 10;
						inputBox_10.style.css({
							"text-align" : "center"
						});
						inputBox_10.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 8);
						...
						inputBox_11.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 7);
						container.addChild(inputBox_11, {
							"colIndex": 2,
							"rowIndex": 1
						});
						var inputBox_12 = new cpr.controls.InputBox("ipb12");
						inputBox_12.fieldLabel = "실제형";
						inputBox_12.maxLength = 10;
						inputBox_12.style.css({
							"text-align" : "center"
						});
						inputBox_12.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 6);
