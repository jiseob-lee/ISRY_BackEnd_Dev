/*
 * App URI: app/cysns/casemng/trlinsp/mindhealthinsp/trlInspResult_0805
 * Source Location: app/cysns/casemng/trlinsp/mindhealthinsp/trlInspResult_0805.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/cysns/casemng/trlinsp/mindhealthinsp/trlInspResult_0805", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// 심리검사결과중분류구분코드
			var trlInspResultMlsfcSeCd = '0805';
			...
			(function(container){
				...
				(function(container){
					...
					group_3.fieldLabel = "비행/문제행동 검사 K-YSR";
					...
					(function(container){
						...
						if(typeof onOpt22ValueChange == "function") {
							output_21.addEventListener("value-change", onOpt22ValueChange);
						}
						...
						inputBox_12.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 0);
						...
						inputBox_13.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 1);
						...
						inputBox_14.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 2);
						...
						inputBox_15.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 3);
						...
						inputBox_16.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 4);
						...
						inputBox_17.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 5);
						...
						inputBox_18.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 6);
						...
						inputBox_19.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 7);
						...
						inputBox_20.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 8);
						...
						inputBox_23.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE", 11);
						...
						inputBox_24.bind("value").toDataSet(app.lookup("dsList"), "INSP_RESULT_VALUE1", 11);
