/*
 * App URI: app/drmgs/dream/ofcdcactionrlt
 * Source Location: app/drmgs/dream/ofcdcactionrlt.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/dream/ofcdcactionrlt", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"FLNM": "홍길동", "BRDT": "2021-01-01", "SXDC": "남", "RQST_YMD": "2021-11-09", "POLICE": "경기남부-화성동탄", "PIC": "화성동탄", "PRGRS_STTUS": "조치결과등록", "ACTN_RESULT": "서비스진행", "REG_INQ": "조회"},
					{"FLNM": "홍길동", "BRDT": "2021-01-01", "SXDC": "남", "RQST_YMD": "2021-11-09", "POLICE": "경기남부-화성동탄", "PIC": "화성동탄", "ACTN_RESULT": "서비스유보", "REG_INQ": "조회", "PRGRS_STTUS": "조치결과등록"},
					{"FLNM": "김영희", "BRDT": "2021-01-01", "SXDC": "여", "RQST_YMD": "2021-11-09", "POLICE": "충남-아산", "PIC": "여가부", "PRGRS_STTUS": "접수완료", "ACTN_RESULT": "", "REG_INQ": "등록"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_7.setColumns(["58px", "260px"]);
					...
					(function(container){
						...
						(function(radioButton_2){
							...
							radioButton_2.addItem(new cpr.controls.Item("연계신청", "value2"));
							radioButton_2.addItem(new cpr.controls.Item("조치결과등록", "value3"));
						})(radioButton_2);
						...
						"detail": {
							...
							"cells": [
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_5.bind("value").toDataColumn("POLICE");
											return inputBox_5;
										})();
									}
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_6.bind("value").toDataColumn("PIC");
											return inputBox_6;
										})();
									}
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_7.bind("value").toDataColumn("ACTN_RESULT");
											return inputBox_7;
										})();
									}
								},
								{
									...
									"configurator": function(cell){
										cell.columnName = "REG_INQ";
										cell.control = (function(){
											var button_1 = new cpr.controls.Button("btn1");
											button_1.style.setClasses(["btn-grid-depth1"]);
											button_1.bind("value").toDataColumn("REG_INQ");
											return button_1;
										})();
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_8.bind("value").toDataColumn("PRGRS_STTUS");
											return inputBox_8;
										})();
									}
								}
