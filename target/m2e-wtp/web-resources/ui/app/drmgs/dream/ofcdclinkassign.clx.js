/*
 * App URI: app/drmgs/dream/ofcdclinkassign
 * Source Location: app/drmgs/dream/ofcdclinkassign.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/dream/ofcdclinkassign", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onBtn1Click(e){
			    var btn1 = e.control;
			    util.Dialog.open(app, "app/drmgs/dream/ofcdclinkassign_doc", "교육청 연계의뢰서 센터배정 상세", 940, 760, function() {
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"FLNM": "홍길동", "BRDT": "2021-01-01", "SXDC": "남", "RQST_YMD": "2021-11-09", "OFCDC": "경기남부-화성동탄", "PIC": "화성동탄", "CENTER_ALTMNT": "미확인", "PRGRS_STTUS": "연계신청"},
					{"FLNM": "김영희", "BRDT": "2021-01-01", "SXDC": "여", "RQST_YMD": "2021-11-09", "OFCDC": "충남-아산", "PIC": "여가부", "CENTER_ALTMNT": "확인", "PRGRS_STTUS": "조치결과등록"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_5.setColumns(["32px", "180px"]);
							...
							"cells": [
								...
								},
								{
									...
									"configurator": function(cell){
										cell.filterable = false;
										cell.sortable = false;
										cell.targetColumnName = "CENTER_ALTMNT";
										cell.text = "센터배정";
									}
								},
								{
