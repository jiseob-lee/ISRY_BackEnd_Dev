/*
 * App URI: app/drmgs/dream/ofcdclinkreg
 * Source Location: app/drmgs/dream/ofcdclinkreg.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/dream/ofcdclinkreg", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"FLNM": "홍길동", "BRDT": "2021-01-01", "SXDC": "남", "RQST_YMD": "2021-11-09", "OFCDC": "경기남부-화성동타", "PIC": "화성동탄", "IDNTY_YN": "미확인", "PRGRS_STTUS": "연계신청"},
					{"FLNM": "김영희", "BRDT": "2021-01-01", "SXDC": "여", "RQST_YMD": "2021-11-09", "OFCDC": "충남-아산", "PIC": "여가부", "IDNTY_YN": "확인", "PRGRS_STTUS": "조치결과등록"}
				]
			});
			...
			(function(container){
				...
				formLayout_2.setColumns(["250px", "260px", "1fr"]);
				...
				formLayout_5.setColumns(["250px", "260px", "1fr"]);
				...
				(function(container){
					...
					formLayout_9.setColumns(["58px", "260px"]);
					...
					(function(container){
						...
						(function(radioButton_3){
							...
							radioButton_3.addItem(new cpr.controls.Item("연계신청", "value2"));
							radioButton_3.addItem(new cpr.controls.Item("조치결과등록", "value3"));
						})(radioButton_3);
			...
			formLayout_10.setRows(["1fr", "28px"]);
