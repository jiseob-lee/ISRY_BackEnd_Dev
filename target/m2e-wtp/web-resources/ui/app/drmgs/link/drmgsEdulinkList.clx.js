/*
 * App URI: app/drmgs/link/drmgsEdulinkList
 * Source Location: app/drmgs/link/drmgsEdulinkList.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/link/drmgsEdulinkList", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onBtn1Click(e){
			    var btn1 = e.control;
			    util.Dialog.open(app, "app/drmgs/link/drmgsEdulinkregModify", "연계의뢰서 상세조회", 940, 760, function() {
			...
			function onBtn2Click(e){
			    var btn2 = e.control;
			    util.Dialog.open(app, "app/drmgs/link/drmgsEduactnList", "연계의뢰서 조치현황 상세조회", 940, 760, function() {
			...
			function onBtnCaseRegInsertClick(e){
			    ...
			    util.Dialog.open(app, "app/drmgs/link/drmgsEdulinkregModify", "연계의뢰서 신청", 940, 760, function() {
			...
			dataSet_1.parseData({
				...
				"rows": [
					...
					{"column1": "김영희", "column2": "2021-01-01", "column3": "여", "column4": "2021-11-09", "column5": "서울-서울시청소년지원센터 꿈드림", "column6": "예", "column7": "접수", "column8": "", "column9": "사례등록"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						var comboBox_3 = new cpr.controls.ComboBox("cmbActnResult");
					...
					(function(container){
						...
						var comboBox_4 = new cpr.controls.ComboBox("cmbPrgrsSttus");
