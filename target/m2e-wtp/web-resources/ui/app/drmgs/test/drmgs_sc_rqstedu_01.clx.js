/*
 * App URI: app/drmgs/test/drmgs_sc_rqstedu_01
 * Source Location: app/drmgs/test/drmgs_sc_rqstedu_01.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstedu_01", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_sc_rqstedu_01.js
			 * @프로그램명 :  
			 * @작성자 : Lee.Sang.Hoon
			 * @작성일자: 2022. 4. 21. 오후 1:28:27
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			function onBtn1Click2(/* cpr.events.CMouseEvent */ e){
			     ...
			     */
			    var btn1 = e.control;
			    util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstedu_02", "교육청 연계의뢰서 상세정보", 940, 760, function(){});
			};
			// End - User Script
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"column1": "홍길동", "column2": "20210101", "column3": "남", "column4": "20211109", "column5": "경기남부-화성동타", "column6": "화성동탄", "column7": "미확인", "column8": "연계신청", "column9": "99"},
					{"column1": "김영희", "column2": "20210101", "column3": "여", "column4": "20211109", "column5": "충남-아산", "column6": "여가부", "column7": "확인", "column8": "조치결과등록", "column9": "98"}
				]
			});
			...
			(function(container){
				...
				formLayout_1.setColumns(["100px", "1fr", "100px", "100px", "100px", "100px", "1fr"]);
				...
				(function(container){
					...
					(function(comboBox_1){
						...
						comboBox_1.addItem(new cpr.controls.Item("남자", "value1"));
						comboBox_1.addItem(new cpr.controls.Item("여자", "value2"));
					})(comboBox_1);
					...
					(function(comboBox_2){
						comboBox_2.addItem(new cpr.controls.Item("전체", "default"));
						comboBox_2.addItem(new cpr.controls.Item("확인", "Y"));
						comboBox_2.addItem(new cpr.controls.Item("미확인", "N"));
					})(comboBox_2);
					...
					(function(comboBox_3){
						comboBox_3.addItem(new cpr.controls.Item("전체", "default"));
						comboBox_3.addItem(new cpr.controls.Item("연계신청", "value1"));
						comboBox_3.addItem(new cpr.controls.Item("조치결과등록", "value2"));
					})(comboBox_3);
			...
			(function(container){
				...
				(function(container){
					var userDefinedControl_4 = new udc.com.comTitle("comGridTitle");
