/*
 * App URI: app/drmgs/test/drmgs_sc_rqstedu_04
 * Source Location: app/drmgs/test/drmgs_sc_rqstedu_04.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstedu_04", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_sc_rqstedu_04.js
			 * @프로그램명 :  
			 * @작성자 : Lee.Sang.Hoon
			 * @작성일자: 2022. 4. 21. 오후 2:44:27
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			function onBtn1Click(/* cpr.events.CMouseEvent */ e){
			     ...
			     */
			    var btn1 = e.control;
			    util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstedu_05", "교육청 연계의뢰서 센터배정", 940, 760, function(){
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"column1": "99", "column2": "홍길동", "column3": "20210101", "column4": "남", "column5": "20211109", "column6": "경기남부-화성동탄", "column7": "화성동탄", "column8": "미확인", "column9": "연계신청"},
					{"column1": "98", "column2": "김영희", "column3": "20210101", "column4": "여", "column5": "20211109", "column6": "충남-아산", "column7": "여가부", "column8": "확인", "column9": "조치결과등록"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					grid_1.fieldLabel = "교육청 연계의뢰서 센터배정 목록";
					grid_1.init({
