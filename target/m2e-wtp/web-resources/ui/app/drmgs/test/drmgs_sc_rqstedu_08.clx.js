/*
 * App URI: app/drmgs/test/drmgs_sc_rqstedu_08
 * Source Location: app/drmgs/test/drmgs_sc_rqstedu_08.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstedu_08", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_2.parseData({
				...
				"rows": [{"column1": "학교밖청소년", "column2": "미진학(초,중,고)0학년", "column3": "기타", "column4": "기타 정보"}]
			});
			...
			(function(container){
				...
				(function(container){
					...
					var output_34 = new cpr.controls.Output("opt9");
					output_34.value = "담당자 소견";
					...
					(function(container){
						...
						(function(comboBox_1){
							comboBox_1.addItem(new cpr.controls.Item("서비스연결", "default"));
						})(comboBox_1);
						...
						(function(comboBox_2){
							comboBox_2.addItem(new cpr.controls.Item("서비스 진행", "default"));
						})(comboBox_2);
			...
			(function(container){
				...
				(function(container){
					var group_15 = new cpr.controls.Container("grpUpdBtns");
					...
					(function(container){
						var button_1 = new cpr.controls.Button("btnDtlUpdate");
