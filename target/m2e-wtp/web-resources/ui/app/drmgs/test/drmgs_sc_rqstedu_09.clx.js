/*
 * App URI: app/drmgs/test/drmgs_sc_rqstedu_09
 * Source Location: app/drmgs/test/drmgs_sc_rqstedu_09.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstedu_09", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_sc_rqstedu_09.js
			 * @프로그램명 :  
			 * @작성자 : Lee.Sang.Hoon
			 * @작성일자: 2022. 4. 21. 오후 4:15:56
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			function onBtn1Click(/* cpr.events.CMouseEvent */ e){
			     ...
			     */
			    var btn1 = e.control;
			    util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstedu_10", "교육청 재개입 조치결과 상세조회", 940, 760, function(){});
			};
			// End - User Script
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"column1": "홍길동", "column2": "20210101", "column3": "남", "column4": "20211109", "column5": "경기남부-화성동타", "column6": "여가부", "column7": "개입완료", "column8": "약속 미이행", "column9": "99"},
					{"column9": "98", "column1": "홍길동", "column2": "20210101", "column3": "남", "column4": "20211109", "column5": "경기남부-화성동탄", "column6": "여가부", "column7": "재개입요청", "column8": ""},
					{"column1": "김영희", "column2": "20210101", "column3": "여", "column4": "20211109", "column5": "충남-아산", "column6": "여가부", "column7": "개입완료", "column8": "통화거부", "column9": "97"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					(function(comboBox_1){
						...
						comboBox_1.addItem(new cpr.controls.Item("개입완료", "value2"));
						comboBox_1.addItem(new cpr.controls.Item("재개입요청", "value3"));
					})(comboBox_1);
					...
					(function(comboBox_2){
						...
						comboBox_2.addItem(new cpr.controls.Item("남", "value2"));
						comboBox_2.addItem(new cpr.controls.Item("여", "value3"));
					})(comboBox_2);
