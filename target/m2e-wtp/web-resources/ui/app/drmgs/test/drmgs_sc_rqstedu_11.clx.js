/*
 * App URI: app/drmgs/test/drmgs_sc_rqstedu_11
 * Source Location: app/drmgs/test/drmgs_sc_rqstedu_11.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstedu_11", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_sc_rqstedu_10.js
			 * @프로그램명 :  
			 * @작성자 : Lee.Sang.Hoon
			 * @작성일자: 2022. 4. 21. 오후 4:24:27
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			function onBodyLoad(/* cpr.events.CEvent */ e){
			    ...
			    // 최초 작성인 경우 아래 코드로 팝업 호출
			//    util.Dialog.open(app, "app/drmgs/drmgs_sc_rqstedu_11", "교육청 재개입 조치결과 등록", 940, 760, function(){}, {mode:"add"});
			    if(voInitValue["mode"]=="add"){
			        app.lookup("btnDtlSave").visible = true;
			        app.lookup("btnDtlUpdate").visible = false;
			    }
			    // 등록된 문서를 열람했을 경우 아래 코드로 팝업 호출
			//    util.Dialog.open(app, "app/drmgs/drmgs_sc_rqstedu_11", "교육청 재개입 조치결과 수정", 940, 760, function(){}, {mode:"modi"});    
			    else {
			        app.lookup("btnDtlSave").visible = false;
			        app.lookup("btnDtlUpdate").visible = true;
			    }
			...
			dataSet_2.parseData({
				...
				"rows": [{"column1": "학교밖청소년", "column2": "미진학(초,중,고)0학년", "column3": "기타", "column4": "@ 학업중단 종류 : 자퇴"}]
			});
			...
			(function(container){
				...
				formLayout_2.setRows(["25px", "25px", "64px"]);
				...
				(function(container){
					...
					output_16.bind("value").toDataSet(app.lookup("ds1"), "column1", 0);
					...
					output_20.bind("value").toDataSet(app.lookup("ds1"), "column2", 0);
					container.addChild(output_20, {
						"colIndex": 1,
						"rowIndex": 1
					});
					var output_21 = new cpr.controls.Output("opt26");
					output_21.bind("value").toDataSet(app.lookup("ds1"), "column3", 0);
					container.addChild(output_21, {
						"colIndex": 3,
						"rowIndex": 1
					});
					var output_22 = new cpr.controls.Output("opt9");
					output_22.bind("value").toDataSet(app.lookup("ds1"), "column4", 0);
			...
			(function(container){
				...
				userDefinedControl_4.title = "[재 개입 의뢰경로]";
				...
				group_6.setBindContext(dataRowContext_2);
				...
				(function(container){
					...
					var output_25 = new cpr.controls.Output("opt36");
			...
			(function(container){
				...
				(function(container){
					...
					output_31.value = "꿈드림센터";
					output_31.style.setClasses(["label"]);
					container.addChild(output_31, {
						"colIndex": 0,
						"rowIndex": 0
					});
					var output_32 = new cpr.controls.Output("opt37");
					output_32.value = "서울-서울시청소년지원센터 꿈드림";
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_6.setColumns(["1fr", "1fr", "100px", "1fr"]);
					...
					(function(container){
						...
						(function(comboBox_1){
							comboBox_1.addItem(new cpr.controls.Item("서비스 진행", "default"));
						})(comboBox_1);
						...
						(function(comboBox_2){
							comboBox_2.addItem(new cpr.controls.Item("서비스연결", "default"));
						})(comboBox_2);
			...
			(function(container){
				var group_14 = new cpr.controls.Container("grpUpdBtns");
	...
	app.title = "교육청 재개입 조치결과 등록/수정(팝업)";
