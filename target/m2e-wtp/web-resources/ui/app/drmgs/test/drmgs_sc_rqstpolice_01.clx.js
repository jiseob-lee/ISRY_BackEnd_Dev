/*
 * App URI: app/drmgs/test/drmgs_sc_rqstpolice_01
 * Source Location: app/drmgs/test/drmgs_sc_rqstpolice_01.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstpolice_01", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_sc_rqstpolice_01.js
			 * @프로그램명 :  
			 * @작성자 : Lee.Seoung.Jae
			 * @작성일자: 2022. 4. 21. 오후 1:27:30
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			 ...
			 * 사용자가 컨트롤을 클릭할 때 발생하는 이벤트.
			 */
			function onBtn1Click1(e){
			    var btn1 = e.control;
			    var grdList = app.lookup("grdList");

			    var grdData = grdList.getCellValue(grdList.getSelectedRowIndex(), 'column9');
			    
			    if(grdData == "연계신청"){
			        util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstpolice_02", "경찰서 연계의뢰서 상세정보",940,740);
			        
			    }else{
			        util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstpolice_03", "경찰서 연계의뢰서 상세정보 수정",940,740);
			    }
			};
			// End - User Script
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"column2": "홍길동", "column3": "20210101", "column4": "남", "column5": "20211109", "column6": "경기남부-화성동타", "column7": "화성동탄", "column8": "미확인", "column9": "연계신청"},
					{"column2": "김영희", "column3": "20210101", "column4": "여", "column5": "20211109", "column6": "충남 - 아산", "column7": "여가부", "column8": "확인", "column9": "조치결과등록"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					(function(comboBox_2){
						...
						comboBox_2.addItem(new cpr.controls.Item("확인", "value2"));
						comboBox_2.addItem(new cpr.controls.Item("미확인", "value3"));
					})(comboBox_2);
					...
					(function(comboBox_3){
						...
						comboBox_3.addItem(new cpr.controls.Item("연계신청", "value2"));
						comboBox_3.addItem(new cpr.controls.Item("조치결과등록", "value3"));
					})(comboBox_3);
								...
								},
								{
									...
									"configurator": function(cell){
										cell.control = (function(){
											...
											if(typeof onBtn1Click1 == "function") {
												button_2.addEventListener("click", onBtn1Click1);
											}
