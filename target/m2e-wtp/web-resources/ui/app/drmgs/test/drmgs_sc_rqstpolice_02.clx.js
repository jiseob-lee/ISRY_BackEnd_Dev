/*
 * App URI: app/drmgs/test/drmgs_sc_rqstpolice_02
 * Source Location: app/drmgs/test/drmgs_sc_rqstpolice_02.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstpolice_02", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_2.parseData({
				...
				"rows": [{"column1": "학교 밖 청소년", "column2": "중 3학년", "column3": "대인관계"}]
			});
			...
			var dataSet_6 = new cpr.data.DataSet("dsList");
			dataSet_6.parseData({
				"columns": [
					{"name": "column1"},
					{"name": "column2"},
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_2.bind("value").toDataSet(app.lookup("ds1"), "column1", 0);
				...
				(function(container){
					...
					(function(container){
						...
						output_8.displayExp = "text + \"(\" + column8 + \"일 경과)\"";
						...
						var output_14 = new cpr.controls.Output("opt30");
				...
				var dataRowContext_3 = new cpr.bind.DataRowContext(app.lookup("ds3"), 0);
				...
				(function(container){
					...
					var output_21 = linker.output_21 = new cpr.controls.Output("opt16");
					output_21.fieldLabel = "경찰청 의뢰 내용";
				...
				var dataRowContext_4 = new cpr.bind.DataRowContext(app.lookup("ds4"), 0);
				...
				(function(container){
					...
					var group_10 = linker.group_10 = new cpr.controls.Container("grp9");
					group_10.fieldLabel = "의뢰경로";
					...
					(function(container){
						...
						var output_24 = new cpr.controls.Output("opt19");
				...
				(function(container){
					...
					(function(container){
						...
						output_31.bind("value").toDataSet(app.lookup("ds5"), "column1", 0);
			...
			linker.userDefinedControl_5.ctrl = linker.output_21;
