/*
 * App URI: app/drmgs/test/drmgs_sc_rqstpolice_04
 * Source Location: app/drmgs/test/drmgs_sc_rqstpolice_04.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstpolice_04", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_sc_rqstpolice_04.js
			 * @프로그램명 :  
			 * @작성자 : Lee.Seoung.Jae
			 * @작성일자: 2022. 4. 21. 오후 2:59:33
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			function onBtn1Click(e){
			    ...
			    var grdData = grdList.getCellValue(grdList.getSelectedRowIndex(), 8);
			    
			    //var grdData = grdList.getCellValue(grdList.getSelectedRowIndex(), 'column9');
			    
			    if(grdData == "조회"){
			        util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstpolice_06", "경찰서 연계의뢰서 조치결과 수정",940,740);
			        
			    }else{
			        util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstpolice_05", "경찰서 연계의뢰서 조치결과 등록",940,740);
			    }
			};
			// End - User Script
			...
			dataSet_1.parseData({
				"columns": [
					...
					{"name": "column7"},
					{
						...
						"dataType": "expression",
						"displayOnly": true,
						"expression": "column7 == '' ? '등록' : '조회'"
					},
					{"name": "column9"}
				],
				"rows": [
					{"column1": "홍길동", "column2": "20210101", "column3": "남", "column4": "20211109", "column5": "경기남부 - 화성동타", "column6": "화성동탄", "column7": "서비스진행", "column9": "조치결과등록"},
					{"column1": "홍길동", "column2": "20210101", "column3": "남", "column4": "20211109", "column5": "경기남부 - 화성동타", "column6": "화성동탄", "column7": "서비스유보", "column9": "조치결과등록"},
					{"column1": "김영희", "column2": "20210101", "column3": "여", "column4": "20211109", "column5": "충남 - 아산", "column6": "여가부", "column7": "", "column9": "접수완료"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					(function(comboBox_2){
						...
						comboBox_2.addItem(new cpr.controls.Item("조치결과등록", "value2"));
						comboBox_2.addItem(new cpr.controls.Item("접수완료", "value3"));
					})(comboBox_2);
			...
			(function(container){
				...
				(function(container){
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											button_2.bind("value").toDataColumn("column10");
											return button_2;
										})();
									}
								},
					...
					if(typeof onBtn1Click == "function") {
						grid_1.addEventListener("click", onBtn1Click);
					}
