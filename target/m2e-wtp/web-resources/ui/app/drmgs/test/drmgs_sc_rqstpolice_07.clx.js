/*
 * App URI: app/drmgs/test/drmgs_sc_rqstpolice_07
 * Source Location: app/drmgs/test/drmgs_sc_rqstpolice_07.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_sc_rqstpolice_07", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_sc_rqstpolice_07.js
			 * @프로그램명 :  
			 * @작성자 : Lee.Seoung.Jae
			 * @작성일자: 2022. 4. 21. 오후 3:35:21
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			/*
			 * "상세" 버튼(btn2)에서 click 이벤트 발생 시 호출.
			 * 사용자가 컨트롤을 클릭할 때 발생하는 이벤트.
			 */
			function onBtn2Click(e){
			    ...
			    var grdData = grdList.getCellValue(grdList.getSelectedRowIndex(), 'column7');
			    
			    if(grdData == "개입완료"){
			        util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstpolice_08", "경찰서 재개입요청 상세정보",940,740);
			        
			    }else{
			        util.Dialog.open(app, "app/drmgs/test/drmgs_sc_rqstpolice_09", "경찰서 재개입요청 조치결과 수정",940,740);
			    }
			};
			// End - User Script
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"column1": "홍길동", "column2": "20210101", "column3": "남", "column4": "20211109", "column5": "경기남부 - 화성동탄", "column6": "화성동탄", "column7": "개입완료", "column8": "약속미이행"},
					{"column1": "홍길동", "column2": "20210101", "column3": "남", "column4": "20211109", "column5": "경기남부 - 화성동탄", "column6": "화성동탄", "column7": "재개입요청", "column8": ""},
					{"column1": "김영희", "column2": "20210101", "column3": "여", "column4": "20211109", "column5": "충남 - 아산", "column6": "여가부", "column7": "개입완료", "column8": "통화거부"}
				]
			});
			...
			(function(container){
				...
				(function(container){
					...
					(function(comboBox_2){
						...
						comboBox_2.addItem(new cpr.controls.Item("개입완료", "value2"));
						comboBox_2.addItem(new cpr.controls.Item("재개입요청", "value3"));
					})(comboBox_2);
