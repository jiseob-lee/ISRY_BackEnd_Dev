/*
 * App URI: app/drmgs/test/drmgs_test01_revisePop
 * Source Location: app/drmgs/test/drmgs_test01_revisePop.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/drmgs/test/drmgs_test01_revisePop", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : drmgs_test01_revisePop.js
			 * @프로그램명 :  
			 * @작성자 : Jeong.Won.Je
			 * @작성일자: 2021. 12. 3. 오전 10:54:40
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/;
			// End - User Script
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_5.setColumns(["4fr", "3fr", "6fr"]);
					...
					(function(container){
						...
						comboBox_1.placeholder = "꿈드림센터 연결";
						container.addChild(comboBox_1, {
							"colIndex": 0,
							"rowIndex": 0
						});
						var comboBox_2 = new cpr.controls.ComboBox("cmb2");
						comboBox_2.placeholder = "꿈드림센터 연계";
						...
						(function(container){
							...
							(function(container){
								...
								(function(radioButton_2){
									radioButton_2.addItem(new cpr.controls.Item("학교밖청소년", "value1"));
									radioButton_2.addItem(new cpr.controls.Item("잠재적학교밖청소년", "value2"));
								})(radioButton_2);
				...
				formLayout_10.setColumns(["90px", "2fr", "1fr", "1fr", "90px", "2fr"]);
				...
				(function(container){
					...
					comboBox_4.placeholder = "미진학(초,중,고)";
					container.addChild(comboBox_4, {
						"colIndex": 1,
						"rowIndex": 0
					});
					var comboBox_5 = new cpr.controls.ComboBox("cmb5");
					comboBox_5.placeholder = "0";
				...
				(function(container){
					...
					formLayout_11.setRows(["30px", "30px", "30px", "30px", "30px", "30px", "30px", "30px", "30px"]);
					...
					(function(container){
						...
						formLayout_12.setColumns(["1fr", "150px", "1fr"]);
						...
						(function(container){
							...
							(function(radioButton_3){
								radioButton_3.addItem(new cpr.controls.Item("본인", "value1"));
								radioButton_3.addItem(new cpr.controls.Item("가족", "value2"));
								radioButton_3.addItem(new cpr.controls.Item("친구 및 선후배", "value3"));
								radioButton_3.addItem(new cpr.controls.Item("기타", "value4"));
							})(radioButton_3);
						...
						radioButton_4.colCount = 3;
						radioButton_4.fixedWidth = false;
						(function(radioButton_4){
							radioButton_4.addItem(new cpr.controls.Item("교육청", "value1"));
							radioButton_4.addItem(new cpr.controls.Item("경찰서 (지구대 포함)", "value2"));
							radioButton_4.addItem(new cpr.controls.Item("청소년상담복지센터(YC,또래상담자,1388전화,117센터,1388청소년지원단 등)", "value3"));
							radioButton_4.addItem(new cpr.controls.Item("지자체(도청,시청,군청,주민센터 등)", "value4"));
							radioButton_4.addItem(new cpr.controls.Item("학교", "value5"));
							radioButton_4.addItem(new cpr.controls.Item("대안학교", "value6"));
							radioButton_4.addItem(new cpr.controls.Item("직업전문학교(직업훈련기관)", "value7"));
							radioButton_4.addItem(new cpr.controls.Item("법무부(법원,가정법원,소년분류심사원,비행예방센터 등)", "value8"));
							radioButton_4.addItem(new cpr.controls.Item("법조인", "value9"));
							radioButton_4.addItem(new cpr.controls.Item("보호관찰", "value10"));
							radioButton_4.addItem(new cpr.controls.Item("소년원", "value11"));
							radioButton_4.addItem(new cpr.controls.Item("검찰청", "value12"));
							radioButton_4.addItem(new cpr.controls.Item("미혼모시설", "value13"));
							radioButton_4.addItem(new cpr.controls.Item("쉼터 및 그룹홈", "value14"));
							radioButton_4.addItem(new cpr.controls.Item("아동복지시설", "value15"));
							radioButton_4.addItem(new cpr.controls.Item("군부대", "value16"));
							radioButton_4.addItem(new cpr.controls.Item("검정고시 학원", "value17"));
							radioButton_4.addItem(new cpr.controls.Item("지역사회(PC방, 노래방, 병원 및 약국 등)", "value18"));
							radioButton_4.addItem(new cpr.controls.Item("자활지원관 및 지역아동센터(방과후 아카데미)", "value19"));
							radioButton_4.addItem(new cpr.controls.Item("아동여성보호지역연대(성폭력가정상담소, 원스톱지원센터, 1366, 해바라기아동센터 등)", "value20"));
							radioButton_4.addItem(new cpr.controls.Item("타 부처산하 상담센터(정신보건센터, 건강가정지원센터, 복지관, 민간상담센터 등)", "value21"));
							radioButton_4.addItem(new cpr.controls.Item("타 꿈드림센터", "value22"));
							radioButton_4.addItem(new cpr.controls.Item("기타", "value23"));
						})(radioButton_4);
				...
				(function(container){
					...
					formLayout_13.topMargin = "2.5px";
					formLayout_13.rightMargin = "5px";
					formLayout_13.bottomMargin = "2.5px";
					...
					formLayout_13.setRows(["30px", "30px", "30px", "30px"]);
					...
					(function(container){
						...
						(function(container){
							...
							radioButton_5.colCount = 5;
							(function(radioButton_5){
								radioButton_5.addItem(new cpr.controls.Item("TV광고", "value1"));
								radioButton_5.addItem(new cpr.controls.Item("라디오광고", "value2"));
								radioButton_5.addItem(new cpr.controls.Item("편의점 · 마트광고", "value3"));
								radioButton_5.addItem(new cpr.controls.Item("PC방광고", "value4"));
								radioButton_5.addItem(new cpr.controls.Item("인터넷(홈페이지)", "value5"));
								radioButton_5.addItem(new cpr.controls.Item("대중교통광고", "value6"));
								radioButton_5.addItem(new cpr.controls.Item("홍보물(리플렛등)", "value7"));
								radioButton_5.addItem(new cpr.controls.Item("아웃리치", "value8"));
								radioButton_5.addItem(new cpr.controls.Item("SNS", "value9"));
								radioButton_5.addItem(new cpr.controls.Item("기타", "value10"));
							})(radioButton_5);
				...
				var group_18 = new cpr.controls.Container("grp49");
				var verticalLayout_5 = new cpr.controls.layouts.VerticalLayout();
				group_18.setLayout(verticalLayout_5);
				(function(container){
					var group_19 = new cpr.controls.Container("grp50");
					...
					var group_20 = new cpr.controls.Container("grp51");
			...
			var group_21 = new cpr.controls.Container("grpBtn");
			...
			formLayout_15.setColumns(["1fr", "60px", "60px"]);
