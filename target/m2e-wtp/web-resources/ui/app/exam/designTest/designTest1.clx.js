/*
 * App URI: app/exam/designTest/designTest1
 * Source Location: app/exam/designTest/designTest1.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/exam/designTest/designTest1", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"column1": "Y", "column2": "Y", "column3": "column31", "column4": "column41", "column5": "column51"},
					{"column1": "N", "column2": "N", "column3": "column32", "column4": "column42", "column5": "column52"},
					{"column1": "Y", "column2": "N", "column3": "column33", "column4": "column43", "column5": "column53"},
					{"column1": "N", "column2": "Y", "column3": "column34", "column4": "column44", "column5": "column54"}
				]
			});
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										comboBox_2.style.bind("background-image").toExpression("getValue(\"column1\") == \"Y\" ? \"url('../ui/theme/dark/images/controls/tabfolder/close-button-selected.png')\" : \"url('../ui/theme/common/images/controls/checkbox/checkbox-partial-selected.svg')\"");
										(function(comboBox_2){
											comboBox_2.addItem(new cpr.controls.Item("합격", "Y"));
											comboBox_2.addItem(new cpr.controls.Item("불합격", "N"));
										})(comboBox_2);
										comboBox_2.bind("value").toDataColumn("column1");
										return comboBox_2;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										comboBox_3.style.bindClass().toExpression("getValue(\"column1\") == \"Y\" ? \"cmb-check-y\" : \"cmb-check-n\"");
										(function(comboBox_3){
											comboBox_3.addItem(new cpr.controls.Item("합격", "Y"));
											comboBox_3.addItem(new cpr.controls.Item("불합격", "N"));
										})(comboBox_3);
										comboBox_3.bind("value").toDataColumn("column2");
										return comboBox_3;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										output_7.bind("value").toExpression("getValue(\"column1\")");
										return output_7;
									})();
								}
							},
