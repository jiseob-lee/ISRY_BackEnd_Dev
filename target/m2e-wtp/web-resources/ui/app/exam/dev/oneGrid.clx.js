	...
	var app = new cpr.core.App("app/exam/dev/oneGrid", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onCombtnsearch1Search(/* cpr.events.CUIEvent */ e){
				...
				// 데이터 변경사항 체크	    
			    if(util.Grid.isModified(app, "grdCmnTmpReg", "CRM", search)) return false;
			...
			submission_2.action = "/sample/listSample.do";
			submission_2.addRequestData(dataMap_2);
			submission_2.addResponseData(dataSet_1, false);
			app.register(submission_2);
			
			var submission_3 = new cpr.protocols.Submission("subSave");
			submission_3.action = "/sample/saveSample.do";
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						var userDefinedControl_4 = linker.userDefinedControl_4 = new udc.com.comBtnGrid("combutton1");
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_5.bind("value").toDataColumn("ENG_NM");
											return inputBox_5;
										})();
									}
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_6.bind("value").toDataColumn("CHA_NM");
											return inputBox_6;
										})();
									}
								},
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_7.userAttr({"columnType": "ssn"});
											inputBox_7.bind("value").toDataColumn("SSN");
											return inputBox_7;
										})();
									}
								},
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_8.bind("value").toDataColumn("DEPT_CD");
											return inputBox_8;
										})();
									}
								},
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_9.bind("value").toDataColumn("ZIPCODE");
											return inputBox_9;
										})();
									}
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_10.bind("value").toDataColumn("ADDR1");
											return inputBox_10;
										})();
									}
								},
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_12.userAttr({"columnType": "phone"});
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_13.bind("value").toDataColumn("AEN");
											return inputBox_13;
										})();
									}
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_14.userAttr({"columnType": "email"});
