/*
 * App URI: app/itgcm/linkmng/inner/linkInnerRcptPrcsPop
 * Source Location: app/itgcm/linkmng/inner/linkInnerRcptPrcsPop.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcm/linkmng/inner/linkInnerRcptPrcsPop", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : linkInnerRcptPrcsInsertPop.js
			 * @프로그램명 :  
			 * @작성자 : Yoo.Chi.Hoon
			 * @작성일자: 2022. 5. 17. 오후 6:14:07
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			function onBtnSaveClick(e){
			    ...
			    var cmb1 = app.lookup("cmb1").value; // 의뢰진행구분
			    var dti1 = app.lookup("dti1").value; //처리일자
			    
			    if(cmb1 == "" || cmb1 == null){
			        
			         util.Msg.alert(app, "의뢰진행구분을 입력 후 저장 바랍니다.", function(){}, "연계접수처리");
			        
			    }else if(dti1 == "" || dti1 == null){
			        
			         util.Msg.alert(app, "처리일자를 입력 후 저장 바랍니다.", function(){}, "연계접수처리");
			        
			    }else {

			        util.Msg.alert(app, "저장 되었습니다.", "연계접수처리");
			        app.close();        
			    }
			};
			// End - User Script
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						(function(comboBox_1){
							comboBox_1.addItem(new cpr.controls.Item("승인", "01"));
							comboBox_1.addItem(new cpr.controls.Item("반려", "02"));
						})(comboBox_1);
