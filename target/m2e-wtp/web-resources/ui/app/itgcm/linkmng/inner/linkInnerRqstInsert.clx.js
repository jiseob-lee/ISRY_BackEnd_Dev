/*
 * App URI: app/itgcm/linkmng/inner/linkInnerRqstInsert
 * Source Location: app/itgcm/linkmng/inner/linkInnerRqstInsert.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcm/linkmng/inner/linkInnerRqstInsert", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : linkInnerRqstInsert.js
			 * @프로그램명 :  
			 * @작성자 : Yoo.Chi.Hoon
			 * @작성일자: 2022. 5. 18. 오후 5:34:37
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_8.value = "예정사용 시간";
						output_8.style.setClasses(["label"]);
						container.addChild(output_8, {
							"colIndex": 6,
							"rowIndex": 1
						});
						var userDefinedControl_3 = new udc.cmn.cmnTimeInput("cmnTimeInput1");
