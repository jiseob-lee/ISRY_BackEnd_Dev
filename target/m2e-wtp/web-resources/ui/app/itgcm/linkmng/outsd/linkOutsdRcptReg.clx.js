/*
 * App URI: app/itgcm/linkmng/outsd/linkOutsdRcptReg
 * Source Location: app/itgcm/linkmng/outsd/linkOutsdRcptReg.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcm/linkmng/outsd/linkOutsdRcptReg", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			userDefinedControl_1.title = "연계대상자접수등록";
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_6.setColumns(["170px", "1fr", "170px", "1fr", "170px", "1fr", "170px", "1fr", "170px", "120px"]);
					...
					(function(container){
						...
						inputBox_8.style.setClasses(["non-readonly"]);
						container.addChild(inputBox_8, {
							"colIndex": 7,
							"rowIndex": 0
						});
						var output_16 = new cpr.controls.Output("opt22");
						output_16.value = "의뢰신청";
						...
						inputBox_9.value = "미신청";
						inputBox_9.style.setClasses(["non-readonly"]);
						...
						(function(comboBox_6){
							comboBox_6.addItem(new cpr.controls.Item("사례대상자의뢰", "01"));
							comboBox_6.addItem(new cpr.controls.Item("복지부연계", "02"));
							comboBox_6.addItem(new cpr.controls.Item("병무청연계", "03"));
							comboBox_6.addItem(new cpr.controls.Item("경찰청연계", "04"));
							comboBox_6.addItem(new cpr.controls.Item("교육부연계", "05"));
						})(comboBox_6);
						...
						var userDefinedControl_6 = new udc.com.comSearchInput("comSearchInput2");
						container.addChild(userDefinedControl_6, {
							"colIndex": 5,
							"rowIndex": 0
						});
						var output_22 = new cpr.controls.Output("opt8");
						output_22.value = "의뢰기관명";
						...
						var userDefinedControl_8 = new udc.cmn.cmnAutoHeightTextArea("cmnAutoHeightTextarea2");
				...
				(function(container){
					...
					(function(container){
						...
						var userDefinedControl_10 = linker.userDefinedControl_10 = new udc.com.comBtnGrid("comBtnGrid1");
				...
				(function(container){
					var userDefinedControl_12 = linker.userDefinedControl_12 = new udc.com.comFormTitle("comFormTitle3");
					...
					var group_13 = linker.group_13 = new cpr.controls.Container("grp12");
					group_13.fieldLabel = "접수상세내용";
					...
					formLayout_9.setColumns(["170px", "105px", "170px", "1fr", "170px", "1fr", "170px", "1fr", "170px", "1fr"]);
					...
					(function(container){
						...
						output_35.value = "재의뢰기관 담당자명";
						output_35.style.setClasses(["label"]);
						container.addChild(output_35, {
							"colIndex": 6,
							"rowIndex": 2
						});
						var output_36 = new cpr.controls.Output("opt44");
						output_36.value = "재의뢰기관 담당자 연락처";
			...
			linker.userDefinedControl_12.ctrl = linker.group_13;
		}
	});
	app.title = "연계대상자 등록";
