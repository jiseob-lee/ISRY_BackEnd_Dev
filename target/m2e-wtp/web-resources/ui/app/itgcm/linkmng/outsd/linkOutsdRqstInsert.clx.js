/*
 * App URI: app/itgcm/linkmng/outsd/linkOutsdRqstInsert
 * Source Location: app/itgcm/linkmng/outsd/linkOutsdRqstInsert.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcm/linkmng/outsd/linkOutsdRqstInsert", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_6.setColumns(["170px", "1fr", "100px", "170px", "1fr", "170px", "1fr"]);
					formLayout_6.setUseColumnShade(0, true);
					formLayout_6.setUseColumnShade(3, true);
					formLayout_6.setUseColumnShade(5, true);
					...
					(function(container){
						...
						var button_1 = new cpr.controls.Button("btnShare");
						button_1.value = "공유자원";
						if(typeof onBtnShareClick == "function") {
							button_1.addEventListener("click", onBtnShareClick);
						}
				...
				(function(container){
					...
					var group_14 = linker.group_14 = new cpr.controls.Container("grp10");
					group_14.fieldLabel = "연계의뢰정보";
				...
				(function(container){
					...
					var group_17 = linker.group_17 = new cpr.controls.Container("grp14");
					group_17.fieldLabel = "의뢰담당자정보";
					...
					(function(container){
						...
						var userDefinedControl_12 = new udc.cmn.cmnAutoHeightTextArea("cmnAutoHeightTextarea1");
						...
						var inputBox_19 = new cpr.controls.InputBox("ipb17");
			...
			linker.userDefinedControl_6.ctrl = linker.group_10;
			linker.userDefinedControl_10.ctrl = linker.group_14;
			linker.userDefinedControl_11.ctrl = linker.group_17;
		}
	});
	app.title = "연계 의뢰요청 등록(ex)";
