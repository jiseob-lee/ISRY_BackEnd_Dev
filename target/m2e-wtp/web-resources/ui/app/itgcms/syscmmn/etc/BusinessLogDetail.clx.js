/*
 * App URI: app/itgcms/syscmmn/etc/BusinessLogDetail
 * Source Location: app/itgcms/syscmmn/etc/BusinessLogDetail.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/syscmmn/etc/BusinessLogDetail", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : BusinessLogDetail.js
			 * @프로그램명 :  
			 * @작성자 : Ji.Seob.Lee
			 * @작성일자: 2022. 4. 27. 오전 10:36:41
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
