/*
 * App URI: app/itgcms/syscmmn/noticePopup/NoticePopupViewOuter
 * Source Location: app/itgcms/syscmmn/noticePopup/NoticePopupViewOuter.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/syscmmn/noticePopup/NoticePopupViewOuter", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onBodyLoad(/* cpr.events.CEvent */ e){
			    ...
			    if (voInitValue) {
			        ...
			        var content = "제목 : " + dmData.getValue("POPUP_NM") 
			            + "<br/>내용 : <br/>" + dmData.getValue("POPUP_DTL_CN");
			        
			        dmData.setValue("POPUP_DTL_CN", content);
