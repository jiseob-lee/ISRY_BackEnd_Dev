/*
 * App URI: app/itgcms/syscmmn/shelter/TrainingEventsApply
 * Source Location: app/itgcms/syscmmn/shelter/TrainingEventsApply.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/syscmmn/shelter/TrainingEventsApply", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : TrainingEventsApply.js
			 * @프로그램명 :  
			 * @작성자 : Ji.Seob.Lee
			 * @작성일자: 2022. 4. 26. 오후 3:12:36
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_5.setColumns(["58px", "230px"]);
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_4.title = "교육 및 행사 신청";
					container.addChild(userDefinedControl_4, {
						"colIndex": 0,
						"rowIndex": 0
					});
					var grid_1 = linker.grid_1 = new cpr.controls.Grid("grdList");
					grid_1.fieldLabel = "교육 및 행사 신청";
