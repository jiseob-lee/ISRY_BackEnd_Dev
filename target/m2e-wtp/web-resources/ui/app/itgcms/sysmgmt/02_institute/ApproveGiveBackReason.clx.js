/*
 * App URI: app/itgcms/sysmgmt/02_institute/ApproveGiveBackReason
 * Source Location: app/itgcms/sysmgmt/02_institute/ApproveGiveBackReason.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/sysmgmt/02_institute/ApproveGiveBackReason", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onBodyLoad(/* cpr.events.CEvent */ e){
			    ...
			    if (voInitValue) {
			        ...
			        dmGiveBack.setValue("INST_NO", instNo);
			        dmGiveBack.setValue("INST_NM", instNm);
			        dmGiveBack.setValue("FRST_RGTR_NM", frstRgtrNm);
			...
			function onBtnSaveClick(e){
			    ...
			    var dmGiveBack = app.lookup("dmGiveBack");
			    dmGiveBack.setValue("REJECT_REASON", txa1.value);
			...
			submission_3.action = "/isry/itgcm/sysmgmt/userauth/rejectInstitute.do";
			...
			(function(container){
				...
				userDefinedControl_2.title = "기관 승인 반려 사유 입력";
				...
				(function(container){
					...
					output_3.bind("value").toDataMap(app.lookup("dmGiveBack"), "INST_NM");
					container.addChild(output_3, {
						"colIndex": 1,
						"rowIndex": 0
					});
					var output_4 = new cpr.controls.Output("opt5");
					output_4.bind("value").toDataMap(app.lookup("dmGiveBack"), "FRST_RGTR_NM");
