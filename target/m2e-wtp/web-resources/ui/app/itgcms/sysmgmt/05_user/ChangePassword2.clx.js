/*
 * App URI: app/itgcms/sysmgmt/05_user/ChangePassword2
 * Source Location: app/itgcms/sysmgmt/05_user/ChangePassword2.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/sysmgmt/05_user/ChangePassword2", { 
			    	...
			    	if (pbSuccess) {
			    		...
			    		if (dmResult != null && dmResult.getValue("msg") != null && dmResult.getValue("msg") != "") {
				    		...
				    		util.Msg.alert(app, "비밀번호가 설정되었습니다.", null, function(){
								 app.getHost().returnValue = ipb2.value;
