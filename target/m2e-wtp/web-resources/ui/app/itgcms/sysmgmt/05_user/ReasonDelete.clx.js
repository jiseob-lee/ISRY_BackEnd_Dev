/*
 * App URI: app/itgcms/sysmgmt/05_user/ReasonDelete
 * Source Location: app/itgcms/sysmgmt/05_user/ReasonDelete.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/sysmgmt/05_user/ReasonDelete", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onBtnSaveClick(e){
			    ...
			    if (txa1.value.trim() == "") {
			        util.Msg.alert(app, "삭제 사유를 입력해주시기 바랍니다.");
			        return;
			    }
			    
			    var dmGiveBack = app.lookup("dmGiveBack");
			    dmGiveBack.setValue("DEL_CS_CN", txa1.value);
			    dmGiveBack.setValue("USER_ID_USE_SE_CD", "5");
			...
			(function(container){
				...
				userDefinedControl_2.title = "회원 가입 삭제 사유 입력";
				...
				textArea_1.placeholder = "회원 가입 삭제 사유를 입력해주시기 바랍니다.";
