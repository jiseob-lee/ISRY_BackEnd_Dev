/*
 * App URI: app/itgcms/sysmgmt/05_user/ReasonStopUsing
 * Source Location: app/itgcms/sysmgmt/05_user/ReasonStopUsing.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/sysmgmt/05_user/ReasonStopUsing", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onBtnSaveClick(e){
			    ...
			    if (txa1.value.trim() == "") {
			        util.Msg.alert(app, "사용중지 사유를 입력해주시기 바랍니다.");
			        return;
			    }
			    
			    var dmGiveBack = app.lookup("dmGiveBack");
			    dmGiveBack.setValue("USE_STPGE_CS_CN", txa1.value);
			    dmGiveBack.setValue("USER_ID_USE_SE_CD", "4");
			    
			    util.Submit.send(app, "subSave", function(pbSuccess) {
			        if (pbSuccess) {
			            util.Msg.alert(app, "사용중지 되었습니다.", null, function(){
							 app.close("GiveBack");
							 //doList("save");
						 });
			        }
			...
			(function(container){
				...
				userDefinedControl_2.title = "회원 가입 사용중지 사유 입력";
				...
				textArea_1.placeholder = "회원 가입 사용중지 사유를 입력해주시기 바랍니다.";
