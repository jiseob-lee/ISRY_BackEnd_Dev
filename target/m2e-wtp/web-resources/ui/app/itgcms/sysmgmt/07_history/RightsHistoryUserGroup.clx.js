/*
 * App URI: app/itgcms/sysmgmt/07_history/RightsHistoryUserGroup
 * Source Location: app/itgcms/sysmgmt/07_history/RightsHistoryUserGroup.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/sysmgmt/07_history/RightsHistoryUserGroup", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : RightsHistoryUserGroup.js
			 * @프로그램명 :  
			 * @작성자 : Ji.Seob.Lee
			 * @작성일자: 2022. 5. 20. 오전 10:20:10
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			submission_1.action = "/isry/itgcm/sysmgmt/history/onLoadRightsHistoryUserGroup.do";
			...
			submission_2.action = "/isry/itgcm/sysmgmt/history/selectRightsHistoryUserGroup.do";
			...
			(function(container){
				...
				formLayout_2.setColumns(["259px", "250px", "258px", "226px"]);
				...
				(function(container){
					...
					formLayout_3.setColumns(["89px", "1fr"]);
					...
					(function(container){
						...
						inputBox_3.bind("value").toDataMap(app.lookup("dmSearch"), "USER_NM");
				...
				formLayout_7.setColumns(["259px", "250px", "258px", "1fr"]);
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							dateInput_1.bind("value").toDataMap(app.lookup("dmSearch"), "USE_BGNG_YMD");
					...
					(function(container){
						...
						dateInput_2.bind("value").toDataMap(app.lookup("dmSearch"), "USE_END_YMD");
				...
				formLayout_12.setColumns(["259px", "250px", "1fr"]);
			...
			group_16.userAttr({"fillLayout": "Y"});
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_4.exportExcelTitle = "권한별 사용자 이력";
							...
							"cells": [
								...
								},
								{
									...
									"configurator": function(cell){
										cell.filterable = false;
										cell.sortable = false;
										cell.targetColumnName = "USE_BGNG_YMD";
										cell.text = "사용시작일자";
									}
								},
								{
									...
									"configurator": function(cell){
										cell.filterable = false;
										cell.sortable = false;
										cell.targetColumnName = "USE_END_YMD";
										cell.text = "사용종료일자";
									}
								},
								{
						...
						"detail": {
							...
							"cells": [
								...
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 4},
									"configurator": function(cell){
										cell.columnName = "USE_BGNG_YMD";
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 5},
									"configurator": function(cell){
										cell.columnName = "USE_END_YMD";
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 6},
