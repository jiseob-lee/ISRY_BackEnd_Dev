/*
 * App URI: app/itgcms/sysmgmt/12_systemenv/SessionTimeout
 * Source Location: app/itgcms/sysmgmt/12_systemenv/SessionTimeout.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.6059), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("app/itgcms/sysmgmt/12_systemenv/SessionTimeout", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Start - User Script
			/************************************************
			 * @파일명 : SessionTimeout.js
			 * @프로그램명 :  
			 * @작성자 : Ji.Seob.Lee
			 * @작성일자: 2022. 3. 16. 오전 9:48:36
			 * @수정로그 : 
			 * [일자, 수정자] 내용 
			 ************************************************/
			...
			userDefinedControl_1.title = "세션 타임아웃 시간";
